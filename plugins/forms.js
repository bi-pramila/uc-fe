...
const formsPlugin = plugin(function ({ addComponents, theme }) {
    addComponents({
        ...
        // 'input[type="range"]': {
        //     '&::-webkit-slider-thumb': {
        //         '@apply bg-fecustom-500 size-4 rounded-full cursor-pointer appearance-none': {},
        //     },
        ...
        //         '@apply py-2 px-4 text-slate-500 bg-slate-100 dark:text-zinc-200 dark:bg-zinc-600 cursor-pointer border-none shadow-none outline-none': {},
        //     },
        //     '&.form-file-sm': {
        //         '&::-webkit-file-upload-button': {
        //             '@apply py-1 px-3': {},
