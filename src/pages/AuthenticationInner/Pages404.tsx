            ...
            <div className="mb-0 border-none shadow-none lg:w-[500px] card bg-white/70 dark:bg-zinc-500/70">
                <div className="!px-10 !py-12 card-body">
                    ...
                    <div className="mt-8 text-center">
                        ...
                        <p className="mb-6 text-slate-500 dark:text-zinc-200">It will be as straightforward as Occidental; in fact, it will be just like Occidental to an English speaker.</p>
                        <Link to="/" className="text-white transition-all duration-200 ease-linear btn bg-fecustom-500 border-fecustom-500 hover:text-white hover:bg-fecustom-600 hover:border-fecustom-600 focus:text-white focus:bg-fecustom-600 focus:border-fecustom-600 focus:ring focus:ring-fecustom-100 active:text-white active:bg-fecustom-600 active:border-fecustom-600 active:ring active:ring-fecustom-100 dark:ring-fecustom-400/20">
