                                ...
                                <Tab.Container defaultActiveKey="emailTabs">
                                    ...
                                    <div className="lg:w-[25rem] mx-auto">
                                        <Nav className="flex flex-wrap w-full gap-2 text-sm font-medium text-center nav-tabs">
                                            <Nav.Item eventKey="emailTabs" className="group grow">
                                                <a href="#!" data-tab-toggle data-target="emailTabs" className="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 bg-slate-100 dark:text-zinc-200 dark:bg-zinc-600 border border-transparent group-[.active]:bg-fecustom-500 dark:group-[.active]:bg-fecustom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-fecustom-500 dark:hover:text-fecustom-500 active:text-fecustom-500 dark:active:text-fecustom-500 -mb-[1px]">
                                            ...
                                            <Nav.Item eventKey="phoneTabs" className="group grow">
                                                <a href="#!" data-tab-toggle data-target="phoneTabs" className="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 bg-slate-100 dark:text-zinc-200 dark:bg-zinc-600 border border-transparent group-[.active]:bg-fecustom-500 dark:group-[.active]:bg-fecustom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-fecustom-500 dark:hover:text-fecustom-500 active:text-fecustom-500 dark:active:text-fecustom-500 -mb-[1px]">
                                    ...
                                    <div>
                                            ...
                                            <Tab.Pane eventKey="emailTabs" className="tab-pane" id="emailTabs">
                                                <form action="/" className="mt-10" id="signInForm">
                                                    <div className="mb-3">
                                                        ...
                                                        <input type="number" id="email-id-field" className="form-input dark:bg-zinc-600/50 border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Enter email" />
                                                    ...
                                                    <div className="mb-3">
                                                        ...
                                                        <input type="text" id="username-field" className="form-input dark:bg-zinc-600/50 border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Enter username" />
                                                    ...
                                                    <div className="mb-3">
                                                        ...
                                                        <input type="password" id="password" className="form-input dark:bg-zinc-600/50 border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Enter password" />
                                            ...
                                            <Tab.Pane eventKey="phoneTabs" className="tab-pane" id="phoneTabs">
                                                <form action="/" className="mt-10" id="signInForm1">
                                                    <div className="mb-3">
                                                        ...
                                                        <input type="number" id="phone-number-field" className="form-input dark:bg-zinc-600/50 border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Enter phone" />
                                                    ...
                                                    <div className="mb-3">
                                                        ...
                                                        <input type="text" id="username-field1" className="form-input dark:bg-zinc-600/50 border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Enter username" />
                                                        <div id="username-error" className="hidden mt-1 text-sm text-red-500">Please enter a username.</div>
                                                    </div>
                                                    <div className="mb-3">
                                                        <label htmlFor="password" className="inline-block mb-2 text-base font-medium">Password</label>
                                                        <input type="password" id="password1" className="form-input dark:bg-zinc-600/50 border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Enter password" />
                                                        <div id="password-error" className="hidden mt-1 text-sm text-red-500">Password must be at least 8 characters long and contain both letters and numbers.</div>
                                                    </div>
                                                    <p className="italic text-15 text-slate-500 dark:text-zinc-200">By registering you agree to the Tailwick <a href="#!" className="underline">Terms of Use</a></p>
                                                    <div className="mt-10">
                                        ...
                                        <div className="relative text-center my-9 before:absolute before:top-3 before:left-0 before:right-0 before:border-t before:border-t-slate-200 dark:before:border-t-zinc-500">
                                            <h5 className="inline-block px-4 py-0.5 text-sm bg-white text-slate-500 dark:bg-zinc-700 dark:text-zinc-200 rounded relative">Create account with</h5>
                                        </div>
                                        ...
                                        <div className="mt-10 text-center">
                                            <p className="mb-0 text-slate-500 dark:text-zinc-200">Already have an account ? <Link to="/auth-login-basic" className="font-semibold underline transition-all duration-150 ease-linear text-slate-500 dark:text-zinc-200 hover:text-fecustom-500 dark:hover:text-fecustom-500">Login</Link> </p>
                                        </div>
                                    </div>
                                </Tab.Container>
                            </div>
