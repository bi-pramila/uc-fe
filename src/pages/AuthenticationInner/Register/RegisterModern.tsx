                            ...
                            <Tab.Container defaultActiveKey="emailLogin">
                                <div className="lg:w-[20rem] mx-auto mt-10">
                                    <Nav className="flex flex-wrap w-full gap-2 text-sm font-medium text-center nav-tabs">
                                        <Nav.Item eventKey="emailLogin" className="group grow">
                                            <a href="#!" data-tab-toggle data-target="emailLogin" className="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 bg-slate-100 dark:text-zinc-200 dark:bg-zinc-600 border border-transparent group-[.active]:bg-fecustom-500 dark:group-[.active]:bg-fecustom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-fecustom-500 dark:hover:text-fecustom-500 active:text-fecustom-500 dark:active:text-fecustom-500 -mb-[1px]">
                                        ...
                                        <Nav.Item eventKey="phoneLogin" className="group grow">
                                            <a href="#!" data-tab-toggle data-target="phoneLogin" className="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 bg-slate-100 dark:text-zinc-200 dark:bg-zinc-600 border border-transparent group-[.active]:bg-fecustom-500 dark:group-[.active]:bg-fecustom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-fecustom-500 dark:hover:text-fecustom-500 active:text-fecustom-500 dark:active:text-fecustom-500 -mb-[1px]">
                                ...
                                <div className="lg:w-[25rem] mx-auto">
                                        ...
                                        <Tab.Pane eventKey="emailLogin" className="tab-pane" id="emailLogin">
                                            <form action="/" className="mt-10" id="signInForm">
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <input type="text" id="username" className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Enter username or email" />
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <input type="password" id="password" className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Enter password" />
                                        ...
                                        <Tab.Pane eventKey="phoneLogin" className="tab-pane" id="phoneLogin">
                                            <form action="/" className="mt-10" id="signInForm1">
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <input type="number" id="phoneNumber" className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Enter phone" />
                                                ...
                                                <div className="mt-10">
                                                    <button type="submit" className="w-full font-medium text-white uppercase transition-all duration-200 ease-linear btn bg-fecustom-500 border-fecustom-500 hover:text-white hover:bg-fecustom-600 hover:border-fecustom-600 focus:text-white focus:bg-fecustom-600 focus:border-fecustom-600 focus:ring focus:ring-fecustom-100 active:text-white active:bg-fecustom-600 active:border-fecustom-600 active:ring active:ring-fecustom-100">Sign In</button>
                                                </div>
                                            </form>
                                        </Tab.Pane>
                                    </Tab.Content>
                                    <div className="relative text-center my-9 before:absolute before:top-3 before:left-0 before:right-0 before:border-t before:border-t-slate-200 dark:before:border-t-zinc-500">
                                        <h5 className="inline-block px-4 py-0.5 text-sm bg-white text-slate-500 dark:text-zinc-200 dark:bg-zinc-700 rounded relative">Already have an account ?</h5>
                                    </div>

                                    <div className="flex flex-wrap justify-center gap-2">
                                        <button type="button" className="flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 text-fecustom-500 btn bg-fecustom-100 border-fecustom-100 hover:text-white hover:bg-fecustom-600 hover:border-fecustom-600 focus:text-white focus:bg-fecustom-600 focus:border-fecustom-600 active:text-white active:bg-fecustom-600 active:border-fecustom-600">
