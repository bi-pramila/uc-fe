                ...
                <div className="!px-10 !py-12 card-body">
                    ...
                    <form action="/" className="mt-10" id="registerForm">
                        <div className="mb-3">
                            ...
                            <input type="text" id="email-field" className="form-input dark:bg-zinc-600/50 border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Enter email" />
