            ...
            <div className="mb-0 border-none shadow-none lg:w-[500px] card bg-white/70 dark:bg-zinc-500/70">
                <div className="!px-10 !py-12 card-body">
                    ...
                    <div className="mt-8 text-center">
                        ...
                        <p className="mb-6 text-slate-500 dark:text-zinc-200">We can't display these images as you're currently not connected to the internet. Once you're back online, please refresh the page or click the button below.</p>
                        <button
