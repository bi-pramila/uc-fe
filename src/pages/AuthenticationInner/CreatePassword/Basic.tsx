                ...
                <div className="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 dark:shadow-zink-500/20 relative">
                  ...
                  onChange={(e) => setNewPassword(e.target.value)} />
                            ...
                            <div className="mt-4 text-center">
                                <p className="mb-0">Hold on, I've got my password... <Link to="/login" className="fw-medium text-custom-500"> Click here to login</Link> </p>
                            </div>
                        </form>
                    </div>
                </div>
