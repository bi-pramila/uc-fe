                ...
                <div className="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 dark:shadow-zink-500/20 relative">
                    <div className="!px-10 !py-12 card-body">
                        ...
                        <div className="mt-8 text-center">
                            ...
                            <p className="mb-8 text-slate-500 dark:text-zink-200">Reset your Ucartz password</p>
                        </div>
                        ...
                        <form autoComplete="off" action="/" onSubmit={handleSubmit}>
                            ...
                            <div className="mt-4 text-center">
                                <p className="mb-0">Wait, I remember my password... <Link to="/login" className=" fw-medium text-custom-500"> Click here to login</Link> </p>
                            </div>
                        </form>
                    </div>
                </div>
