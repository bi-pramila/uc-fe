    ...
    return (
        <React.Fragment>
            <div className="relative">
                ...
                <div className="mb-0 w-screen lg:mx-auto lg:w-[500px] card shadow-lg border-none shadow-slate-100 dark:shadow-zinc-500/20 relative">
                    <div className="!px-10 !py-12 card-body">
                        ...
                        <form action="/" className="mt-10" id="signInForm">
                            ...
                            <div className="mt-10 text-center">
                                <p className="mb-0 text-slate-500 dark:text-zinc-200">Don't have an account ? <Link to="/auth-register-basic" className="font-semibold underline transition-all duration-150 ease-linear text-slate-500 dark:text-zinc-200 hover:text-fecustom-500 dark:hover:text-fecustom-500"> SignUp</Link> </p>
                            </div>
                        </form>
                    </div>
                </div>
