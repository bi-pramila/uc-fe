                            ...
                            <Tab.Container defaultActiveKey="emailLogin">
                                ...
                                <div className="lg:w-[25rem] mx-auto">
                                    <Tab.Content className="mt-5 tab-content">
                                        ...
                                        <Tab.Pane eventKey="phoneLogin" className="tab-pane" id="phoneLogin">
                                            <form action="/" className="mt-10" id="signInForm2">
                                                ...
                                                <div className="mb-3">
                                                    <label htmlFor="password" className="inline-block mb-2 text-base font-medium">Password</label>
                                                    <input type="password" id="password2" className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Enter password" />
                                                    <div id="password-error" className="hidden mt-1 text-sm text-red-500">Password must be at least 8 characters long and contain both letters and numbers.</div>
                                                </div>
                                                <div>
                                                    <div className="flex items-center gap-2">
                                    ...
                                    <div className="relative text-center my-9 before:absolute before:top-3 before:left-0 before:right-0 before:border-t before:border-t-slate-200 dark:before:border-t-zinc-500">
                                        <h5 className="inline-block px-4 py-0.5 text-sm bg-white text-slate-500 dark:bg-zinc-700 dark:text-zinc-200 rounded relative">Sign In with</h5>
                                    </div>
                                    ...
                                    <div className="mt-10 text-center">
                                        <p className="mb-0 text-slate-500 dark:text-zinc-200">Don't have an account ? <Link to="/auth-register-modern" className="font-semibold underline transition-all duration-150 ease-linear text-slate-500 dark:text-zinc-200 hover:text-fecustom-500"> SignUp</Link> </p>
                                    </div>
