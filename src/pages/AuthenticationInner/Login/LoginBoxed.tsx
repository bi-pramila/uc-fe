                        ...
                        <div className="lg:col-span-5">
                            <div className="!px-12 !py-12 card-body">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-slate-500 dark:text-zinc-200">Sign in to continue to Tailwick.</p>
                                </div>
                                ...
                                <form action="/" className="mt-10" id="signInForm">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="text" id="username" className="form-input dark:bg-zinc-600/50 border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Enter username or email" />
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2">
                                            <input id="checkboxDefault1" className="size-4 border rounded-sm appearance-none bg-slate-100 border-slate-200 dark:bg-zinc-600/50 dark:border-zinc-500 checked:bg-fecustom-500 checked:border-fecustom-500 dark:checked:bg-fecustom-500 dark:checked:border-fecustom-500 checked:disabled:bg-fecustom-400 checked:disabled:border-fecustom-400" type="checkbox" defaultValue="" />
                                    ...
                                    <div className="mt-10 text-center">
                                        <p className="mb-0 text-slate-500 dark:text-zinc-200">Don't have an account ? <Link to="/auth-register-boxed" className="font-semibold underline transition-all duration-150 ease-linear text-slate-500 dark:text-zinc-200 hover:text-fecustom-500 dark:hover:text-fecustom-500"> SignUp</Link> </p>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <div className="flex items-center justify-between gap-3">
                                    ...
                                    <div className="shrink-0">
                                        <div className="relative dropdown text-end">
                                            <button type="button" className="inline-flex items-center gap-3 transition-all duration-200 ease-linear dropdown-toggle btn border-slate-200 dark:border-zinc-400/60 group/items focus:border-fecustom-500 dark:focus:border-fecustom-500" id="dropdownMenuButton" data-bs-toggle="dropdown">
