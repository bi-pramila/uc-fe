                ...
                <div className="!px-10 !py-12 card-body">
                    ...
                    <form action="#!" className="mt-10" id="signInForm">
                        ...
                        <div className="mt-10 text-center">
                            <p className="mb-0 text-slate-500 dark:text-zinc-200">Don't have an account ? <Link to="/auth-register-cover" className="font-semibold underline transition-all duration-150 ease-linear text-slate-500 dark:text-zinc-200 hover:text-fecustom-500 dark:hover:text-fecustom-500"> SignUp</Link> </p>
                        </div>
                    </form>
                </div>
            </div>
