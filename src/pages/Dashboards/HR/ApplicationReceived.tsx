            ...
            <div className="col-span-12 md:order-7 2xl:order-5 lg:col-span-12 2xl:col-span-6 2xl:row-span-2 card">
                <div className="card-body">
                    <div className="flex items-center gap-2 MB-3">
                        <h6 className="mb-0 text-15 grow">Application Received</h6>
                        <div className="relative flex items-center gap-2 dropdown shrink-0">
                            <button type="button" className="flex items-center justify-center size-8 p-0 text-xs text-white btn bg-fecustom-500 border-fecustom-500 hover:text-white hover:bg-fecustom-600 hover:border-fecustom-600 focus:text-white focus:bg-fecustom-600 focus:border-fecustom-600 focus:ring focus:ring-fecustom-100 active:text-white active:bg-fecustom-600 active:border-fecustom-600 active:ring active:ring-fecustom-100 dark:ring-fecustom-400/20">All</button>
