        ...
        <React.Fragment>
            ...
            <div className="order-5 col-span-12 2xl:order-1 card 2xl:row-span-2 2xl:col-span-8">
                <div className="card-body">
                    ...
                    {/* <div id="platformPerspective" className="apex-charts" data-chart-colors='["bg-fecustom-500"]' dir="ltr"></div> */}
                    <PerspectiveChart chartId="platformPerspective"  data-chart-colors='["bg-fecustom-500"]' />
                    <div id="chartdiv"></div>
                </div>
            </div>
