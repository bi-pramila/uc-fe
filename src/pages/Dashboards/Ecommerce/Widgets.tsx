        ...
        <React.Fragment>
            <div className="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                <div className="text-center card-body">
                    <div className="flex items-center justify-center mx-auto rounded-full size-14 bg-fecustom-100 text-fecustom-500 dark:bg-fecustom-500/20">
                        <Wallet2 />
                    </div>
                    <h5 className="mt-4 mb-2">$
                        <CountUp end={236.18} decimals={2} className="counter-value" />
                        k</h5>
                    <p className="text-slate-500 dark:text-zinc-200">Total Revenue</p>
                </div>
            </div>
            <div className="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                <div className="text-center card-body">
            ...
            <div className="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                <div className="text-center card-body">
                    ...
                    <p className="text-slate-500 dark:text-zinc-200">Delivered</p>
                </div>
            </div>
            <div className="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                <div className="text-center card-body">
                    ...
                    <p className="text-slate-500 dark:text-zinc-200">Cancelled</p>
                </div>
            </div>
        </React.Fragment>
    );
