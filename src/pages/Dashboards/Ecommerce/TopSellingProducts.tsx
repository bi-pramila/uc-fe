                ...
                <div className="card-body">
                    <div className="flex items-center mb-3">
                        ...
                        <Dropdown className="relative shrink-0">
                            <Dropdown.Trigger type="button" className="flex items-center justify-center size-[30px] p-0 bg-white text-slate-500 btn hover:text-slate-500 hover:bg-slate-100 focus:text-slate-500 focus:bg-slate-100 active:text-slate-500 active:bg-slate-100 dark:bg-zinc-700 dark:hover:bg-slate-500/10 dark:focus:bg-slate-500/10 dark:active:bg-slate-500/10 dropdown-toggle" id="sellingProductDropdown" data-bs-toggle="dropdown">
                                <MoreVertical className="inline-block size-4"></MoreVertical>
                            </Dropdown.Trigger>

                            <Dropdown.Content placement="right-end" className="absolute z-50 py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zinc-600" aria-labelledby="sellingProductDropdown">
                                <li>
                    ...
                    <ul className="flex flex-col gap-5">
                        <li className="flex items-center gap-3">
                            <div className="flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zinc-600">
                            ...
                            <h6 className="shrink-0"><ShoppingCart className="inline-block size-4 align-middle text-slate-500 dark:text-zinc-200 ltr:mr-1 rtl:ml-1"></ShoppingCart> 798</h6>
                        </li>
                        <li className="flex items-center gap-3">
                            <div className="flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zinc-600">
                            ...
                            <h6 className="shrink-0"><ShoppingCart className="inline-block size-4 align-middle text-slate-500 dark:text-zinc-200 ltr:mr-1 rtl:ml-1"></ShoppingCart> 695</h6>
                        </li>
                        <li className="flex items-center gap-3">
                            <div className="flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zinc-600">
                            ...
                            <h6 className="shrink-0"><ShoppingCart className="inline-block size-4 align-middle text-slate-500 dark:text-zinc-200 ltr:mr-1 rtl:ml-1"></ShoppingCart> 985</h6>
                        </li>
                        <li className="flex items-center gap-3">
                            <div className="flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zinc-600">
                            ...
                            <h6 className="shrink-0"><ShoppingCart className="inline-block size-4 align-middle text-slate-500 dark:text-zinc-200 ltr:mr-1 rtl:ml-1"></ShoppingCart> 813</h6>
                        </li>
                        <li className="flex items-center gap-3">
                            <div className="flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zinc-600">
                            ...
                            <h6 className="shrink-0"><ShoppingCart className="inline-block size-4 align-middle text-slate-500 dark:text-zinc-200 ltr:mr-1 rtl:ml-1"></ShoppingCart> 915</h6>
                        </li>
                        <li className="flex items-center gap-3">
                            <div className="flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zinc-600">
                                <img src={img03} alt="" className="h-6" />
                            ...
                            <h6 className="shrink-0"><ShoppingCart className="inline-block size-4 align-middle text-slate-500 dark:text-zinc-200 ltr:mr-1 rtl:ml-1"></ShoppingCart> 785</h6>
                        </li>
                    </ul>
                </div>
            </div>
