                ...
                <div className="card-body">
                    <div className="flex items-center mb-3">
                        ...
                        <Dropdown className="relative shrink-0">
                            <Dropdown.Trigger type="button" className="flex items-center justify-center size-[30px] p-0 bg-white text-slate-500 btn hover:text-slate-500 hover:bg-slate-100 focus:text-slate-500 focus:bg-slate-100 active:text-slate-500 active:bg-slate-100 dark:bg-zinc-700 dark:hover:bg-slate-500/10 dark:focus:bg-slate-500/10 dark:active:bg-slate-500/10 dropdown-toggle" id="customServiceDropdown" data-bs-toggle="dropdown">
                                <MoreVertical className="inline-block size-4"></MoreVertical>
                            </Dropdown.Trigger>

                            <Dropdown.Content placement="right-end" className="absolute z-50 py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zinc-600" aria-labelledby="customServiceDropdown">
                                <li>
                    ...
                    <div>
                        <div className="flex items-center justify-between mt-5 mb-2">
                            <p className="text-slate-500 dark:text-zinc-200">28% of the Goal Reached ($25k)</p>
                        </div>
                        <div className="w-full h-2 rounded-full bg-slate-200 dark:bg-zinc-600">
                        ...
                        <div className="grid mt-3 xl:grid-cols-2">
                            <div className="flex items-center gap-2">
                                ...
                                <p className="mb-0 text-slate-500 dark:text-zinc-200">This Month: <span className="font-medium text-slate-800 dark:text-zinc-50">$13,741</span></p>
                            </div>
                        </div>
                    </div>
                    <h6 className="mt-4 mb-3">Top Customer</h6>
                    <ul className="divide-y divide-slate-200 dark:divide-zinc-500">
                        <li className="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                            <div className="size-8 rounded-full shrink-0 bg-slate-100 dark:bg-zinc-600">
                                <img src={avatar2} alt="" className="size-8 rounded-full" />
                            </div>
                            <div className="grow">
                                <h6 className="font-medium">Urrie Arthur</h6>
                                <p className="text-slate-500 dark:text-zinc-200">arthur@tailwick.com</p>
                            </div>
                            <div className="shrink-0">
                                <h6>$2,452</h6>
                            </div>
                        ...
                        <li className="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                            ...
                            <div className="grow">
                                ...
                                <p className="text-slate-500 dark:text-zinc-200">natalie@tailwick.com</p>
                            </div>
                            <div className="shrink-0">
                                <h6>$1,893</h6>
                            </div>
                        ...
                        <li className="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                            ...
                            <div className="grow">
                                ...
                                <p className="text-slate-500 dark:text-zinc-200">jackson@tailwick.com</p>
                            </div>
                            <div className="shrink-0">
                                <h6>$1,196</h6>
                            </div>
                        ...
                        <li className="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                            ...
                            <div className="grow">
                                ...
                                <p className="text-slate-500 dark:text-zinc-200">torres@tailwick.com</p>
                            </div>
                            <div className="shrink-0">
                                <h6>$976</h6>
                            </div>
