        ...
        <React.Fragment>
            <div className="col-span-12 lg:col-span-7 xl:col-span-9 2xl:col-span-6">
                            ...
                            <div className="flex gap-4">
                                {(storyData || []).map((item: any, key: number) => (
                                    <Link to="#inline-example" className={`block w-20 px-1 py-2 group highlight-story ${item.isActive && "active"}`} data-glightbox="max-width: 28rem;" key={key} onClick={() => setStoryBox(true)}>
                                        ...
                                        <div className={`size-16 mx-auto rounded-full ${item.bgColor} outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zinc-500 group-[.active]:outline-fecustom-500 dark:group-[.active]:outline-fecustom-700 relative`}>
                    ...
                    <div className="card-body">
                        <div className="flex gap-3">
                            <ul className="flex gap-3 grow">
                                <li>
                                    <Link to="#!"><Video className="inline-block size-4 text-red-500 ltr:mr-1 rtl:ml-1" /> <span className="align-middle text-slate-500 dark:text-zinc-200">Live Video</span></Link>
                                </li>
                                <li>
                                    <Link to="#!" onClick={defaultToggle}><Image className="inline-block size-4 ltr:mr-1 text-fecustom-600 rtl:ml-1" /> <span className="align-middle text-slate-500 dark:text-zinc-200">Image/Video</span></Link>
                                </li>
                                <li>
                                    <Link to="#!" onClick={defaultEventToggle}><CalendarDays className="inline-block size-4 text-green-500 ltr:mr-1 rtl:ml-1" /> <span className="align-middle text-slate-500 dark:text-zinc-200">Event</span></Link>
                                </li>
                                <li>
                                    <Link to="#!"><AtSign className="inline-block size-4 ltr:mr-1 text-sky-500 rtl:ml-1" /> <span className="align-middle text-slate-500 dark:text-zinc-200">Mention</span></Link>
                                </li>
                            </ul>
                            <Dropdown className="relative dropdown shrink-0">
                                ...
                                <Dropdown.Content placement="right-end" className="absolute z-50 py-2 mt-1 text-left list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zinc-600" aria-labelledby="socialMediaCreate">
                                    <li>
                                        <Link className="block px-4 py-1.5 text-base transition-all duration-200 ease-linear dark:text-zinc-100 dark:hover:bg-zinc-500 dark:hover:text-zinc-200 dark:focus:bg-zinc-500 dark:focus:text-zinc-200 text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500" to="#!"><GitPullRequest className="inline-block size-3 mr-1" /> <span className="align-middle">Create a poll</span></Link>
                                    </li>
                                    <li>
                ...
                <div className="card">
                    <div className="card-body">
                        <div className="flex flex-wrap items-center gap-3 mb-5">
                            <div className="size-12 bg-green-100 rounded-full outline-1 outline outline-transparent outline-offset-[3px] [&.active]:outline-fecustom-500 shrink-0 dark:bg-green-500/20">
                                <img src={avatar8} alt="" className="size-12 rounded-full" />
                            </div>
                            <div className="grow">
                                <h6 className="mb-1 text-15"><Link to="#!" className="transition-all duration-200 ease-linear hover:text-fecustom-500 dark:hover:text-fecustom-500">Frances Zboncak</Link> -<small className="ml-1 font-normal text-slate-500 dark:text-zinc-200">25 min</small></h6>
                                <p className="text-slate-500 dark:text-zinc-200">Web Developer at <Link to="#!" className="underline">Themesdesign</Link></p>
                            </div>
                    ...
                    <div className="border-y border-slate-200 card-body dark:border-zinc-500">
                        <ul className="flex items-center gap-4 mb-0">
                            <li>
                                <Link to="#!" className="text-slate-500 dark:text-zinc-200"><MessagesSquare className="inline-block size-4 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">48 Comments</span></Link>
                            </li>
                            <li>
                                <Link to="#!" className="text-slate-500 dark:text-zinc-200"><Heart className="inline-block size-4 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">257 Likes</span></Link>
                            </li>
                            <li>
                                <Link to="#!" className="text-slate-500 dark:text-zinc-200"><Send className="inline-block size-4 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">13 Share</span></Link>
                            </li>
                            <li className="ltr:ml-auto rtl:mr-auto">
                                <Link to="#!" className="text-slate-500 dark:text-zinc-200"><Bookmark className="inline-block size-4 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">7</span></Link>
                            </li>
                        </ul>
                    </div>
                    <div className="card-body">
                            ...
                            <div className="flex gap-3">
                                ...
                                <div className="grow">
                                    <div className="p-3 rounded-md bg-slate-100 dark:bg-zinc-600">
                                        <h6 className="mb-3 text-15"><Link to="#!">@bertha34</Link> - <span className="text-sm font-normal text-slate-500 dark:text-zinc-200">14 June, 2023</span></h6>
                                        ...
                                        <div className="flex items-center gap-2 mt-4">
                                            <Link to="#!" className="px-2.5 py-0.5 text-xs font-medium rounded border bg-white border-slate-200 text-slate-500 transition hover:bg-slate-200 dark:text-zinc-200 dark:bg-slate-700 dark:border-zinc-500">Like (3)</Link>
                                            <Link to="#!" className="px-2.5 py-0.5 text-xs font-medium rounded border bg-white border-slate-200 text-slate-500 transition hover:bg-slate-200 dark:text-zinc-200 dark:bg-slate-700 dark:border-zinc-500">Reply</Link>
                                        </div>
                                    </div>
                                    <div className="flex gap-3 mt-4">
                                        ...
                                        <div className="grow">
                                            <div className="p-3 rounded-md bg-slate-100 dark:bg-zinc-600">
                                                <h6 className="mb-3 text-15"><Link to="#!">@frances_zboncak</Link> - <span className="text-sm font-normal text-slate-500 dark:text-zinc-200">14 June, 2023</span></h6>
                                                ...
                                                <p>Thank you</p>
                                                <div className="flex items-center gap-2 mt-4">
                                                    <Link to="#!" className="px-2.5 py-0.5 text-xs font-medium rounded border bg-white border-slate-200 text-slate-500 transition hover:bg-slate-200 dark:text-zinc-200 dark:bg-slate-700 dark:border-zinc-500">Like (6)</Link>
                                                    <Link to="#!" className="px-2.5 py-0.5 text-xs font-medium rounded border bg-white border-slate-200 text-slate-500 transition hover:bg-slate-200 dark:text-zinc-200 dark:bg-slate-700 dark:border-zinc-500">Reply</Link>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className="card">
                    <div className="card-body">
                        <div className="flex flex-wrap items-center gap-3 mb-5">
                            ...
                            <div className="grow">
                                <h6 className="mb-1 text-15"><Link to="#!" className="transition-all duration-200 ease-linear hover:text-fecustom-500 dark:hover:text-fecustom-500">Stephen Tillman</Link> -<small className="ml-1 font-normal text-slate-500 dark:text-zinc-200">25 min</small></h6>
                                <p className="text-slate-500 dark:text-zinc-200">React Developer at <Link to="#!" className="underline">Webfox Info</Link></p>
                            </div>
                            <div className="flex flex-wrap items-center gap-2 mt-4 shrink-0 md:mt-4">
                                ...
                                <Dropdown className="relative dropdown">
                                    ...
                                    <Dropdown.Content placement="right-end" className="absolute z-50 py-2 mt-1 text-left list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zinc-600" aria-labelledby="socialPost2">
                                        <li>
                                            <Link className="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zinc-100 dark:hover:bg-zinc-500 dark:hover:text-zinc-200 dark:focus:bg-zinc-500 dark:focus:text-zinc-200" to="#!"><GitPullRequest className="inline-block size-3 mr-1" /> <span className="align-middle">Create a poll</span></Link>
                                        </li>
                                        <li>
                                            <Link className="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zinc-100 dark:hover:bg-zinc-500 dark:hover:text-zinc-200 dark:focus:bg-zinc-500 dark:focus:text-zinc-200" to="#!"><MessagesSquare className="inline-block size-3 mr-1" /> <span className="align-middle">Ask a question</span></Link>
                                        </li>
                                        <li>
                                            <Link className="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zinc-100 dark:hover:bg-zinc-500 dark:hover:text-zinc-200 dark:focus:bg-zinc-500 dark:focus:text-zinc-200" to="#!"><HelpCircle className="inline-block size-3 mr-1" /> <span className="align-middle">Help</span></Link>
                                        </li>
                                    </Dropdown.Content>
                                </Dropdown>
                            </div>
                    ...
                    <div className="border-y border-slate-200 card-body dark:border-zinc-500">
                        <ul className="flex items-center gap-4 mb-0">
                            <li>
                                <Link to="#!" className="text-slate-500 dark:text-zinc-200"><MessagesSquare className="inline-block size-4 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">224 Comments</span></Link>
                            </li>
                            <li>
                                <Link to="#!" className="text-slate-500 dark:text-zinc-200"><Heart className="inline-block size-4 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">746 Likes</span></Link>
                            </li>
                            <li>
                                <Link to="#!" className="text-slate-500 dark:text-zinc-200"><Send className="inline-block size-4 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">47 Share</span></Link>
                            </li>
                            <li className="ltr:ml-auto rtl:mr-auto">
                                <Link to="#!" className="text-slate-500 dark:text-zinc-200"><Bookmark className="inline-block size-4 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">139</span></Link>
                            </li>
                        </ul>
                    </div>
                    <div className="card-body">
                ...
                <div className="card">
                    <div className="card-body">
                        <div className="flex flex-wrap items-center gap-3 mb-5">
                            ...
                            <div className="flex items-center gap-2 mt-4 shrink-0 md:mt-4">
                                ...
                                <Dropdown className="relative dropdown">
                                    ...
                                    <Dropdown.Content placement="right-end" className="absolute z-50 py-2 mt-1 text-left list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zinc-600" aria-labelledby="socialPost3">
                                        <li>
                                            <Link className="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zinc-100 dark:hover:bg-zinc-500 dark:hover:text-zinc-200 dark:focus:bg-zinc-500 dark:focus:text-zinc-200" to="#!"><GitPullRequest className="inline-block size-3 mr-1" /> <span className="align-middle">Create a poll</span></Link>
                                        </li>
                                        <li>
                        ...
                        <ul className="inline-flex flex-col gap-3 p-4 mt-4 rounded-md w-80 bg-slate-100 max-w-7xl dark:bg-zinc-600">
                            <li>
                                <Link to="#!" className="relative flex gap-4 group active">
                                    ...
                                    <div className="grow">
                                        <h6>React Js</h6>
                                        <div className="w-full h-1.5 rounded-full bg-white dark:bg-zinc-700 mt-2">
                                            <div className="h-1.5 rounded-full bg-fecustom-500" style={{ width: "75%" }}></div>
                                        </div>
                                    </div>
                                </Link>
                            </li>
                            <li>
                                <Link to="#!" className="relative flex gap-3 group">
                                    ...
                                    <div className="grow">
                                        <h6>Laravel</h6>
                                        <div className="w-full h-1.5 rounded-full bg-white dark:bg-zinc-700 mt-2">
                                            <div className="h-1.5 rounded-full bg-fecustom-500" style={{ width: "41%" }}></div>
                                        </div>
                                    </div>
                                </Link>
                            </li>
                            <li>
                                <Link to="#!" className="relative flex gap-3 group">
                                    ...
                                    <div className="grow">
                                        ...
                                        <div className="w-full h-1.5 rounded-full bg-white dark:bg-zinc-700 mt-2">
                                            <div className="h-1.5 rounded-full bg-fecustom-500" style={{ width: "63%" }}></div>
                                        </div>
                                    </div>
                                </Link>
                            </li>
                    ...
                    <div className="border-y border-slate-200 card-body dark:border-zinc-500">
                        <ul className="flex items-center gap-4 mb-0">
                            <li>
                                <Link to="#!" className="text-slate-500 dark:text-zinc-200"><MessagesSquare className="inline-block size-4 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">495 Comments</span></Link>
                            </li>
                            <li>
                                <Link to="#!" className="text-slate-500 dark:text-zinc-200"><Heart className="inline-block size-4 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">1.3k Likes</span></Link>
                            </li>
                            <li>
                                <Link to="#!" className="text-slate-500 dark:text-zinc-200"><Send className="inline-block size-4 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">203 Share</span></Link>
                            </li>
                            <li className="ltr:ml-auto rtl:mr-auto">
                                <Link to="#!" className="text-slate-500 dark:text-zinc-200"><Bookmark className="inline-block size-4 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">159</span></Link>
                            </li>
                        </ul>
                    </div>
                    <div className="card-body">
            ...
            <Modal show={defaultModal} onHide={defaultToggle} modal-center="true"
                ...
                <Modal.Header className="flex items-center justify-between p-4 border-b dark:border-zinc-500"
                    closeButtonClass="transition-all duration-200 ease-linear text-slate-500 dark:text-zinc-200 hover:text-red-500 dark:hover:text-red-500">
                ...
                <Modal.Body className="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                    <form action="#!">
                        <div className="mb-4">
                            ...
                            <input type="text" id="postTitle" className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Enter title" />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="descriptionInput" className="inline-block mb-2 text-base font-medium">Description</label>
                            <textarea className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" id="descriptionInput" rows={3}></textarea>
                        </div>
                        <div className="mb-4">
                            <label htmlFor="mentionUserSelect" className="inline-block mb-2 text-base font-medium">@Mention</label>
                            <input className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" id="mentionUserSelect" data-choices data-choices-text-unique-true type="text" defaultValue="@shaylee-pouros" />
                        </div>
                        <div className="mb-4">
                                ...
                                {({ getRootProps }: any) => (
                                    <div className="flex items-center justify-center bg-white border border-dashed rounded-md cursor-pointer dropzone border-slate-300 dropzone2 dark:bg-zinc-700 dark:border-zinc-500">
                                        <div className="w-full py-5 text-lg text-center dz-message needsclick" {...getRootProps()} >
                                            <div className="mb-3">
                                                <UploadCloud className="block size-12 mx-auto text-slate-500 fill-slate-200 dark:text-zinc-200 dark:fill-zinc-600" />
                                            </div>
                                            <h5 className="mb-0 font-normal text-slate-500 dark:text-zinc-200 text-15">Drag and drop your images / video or <Link to="#!">browse</Link> your images / video</h5>
                                        </div>
                                    </div>
                                )}
                            </Dropzone>
                                            ...
                                            <li className="mt-5" id="dropzone-preview-list2">
                                                <div className="border rounded border-slate-200 dark:border-zinc-500">
                                                    <div className="p-2 text-center">
                                                        <div>
                                                            <div className="p-2 mx-auto rounded-md size-14 bg-slate-100 dark:bg-zinc-500">
                                                                <img className="block w-full h-full rounded-md" src={file.priview} alt={file.name} />
                                                            </div>
                                                        </div>
                                                        <div className="pt-3">
                                                            <h5 className="mb-1 text-15">{file.path}</h5>
                                                            <p className="mb-0 text-slate-500 dark:text-zinc-200">{file.formattedSize}</p>
                ...
                <Modal.Body className="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                    <form action="#!">
                        ...
                        <div className="mb-4">
                            ...
                            <textarea className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" id="descriptionEventInput" rows={2}></textarea>
                        </div>
                        <div className="mb-4">
                            <label htmlFor="location" className="inline-block mb-2 text-base font-medium">Location</label>
                            <input className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" id="location" type="text" placeholder="Enter location" />
                        </div>
                        <div className="text-right">
                            <button type="submit" className="text-white btn bg-fecustom-500 border-fecustom-500 hover:text-white hover:bg-fecustom-600 hover:border-fecustom-600 focus:text-white focus:bg-fecustom-600 focus:border-fecustom-600 focus:ring focus:ring-fecustom-100 active:text-white active:bg-fecustom-600 active:border-fecustom-600 active:ring active:ring-fecustom-100 dark:ring-fecustom-400/20">Create Event</button>
                        </div>
                    </form>
                </Modal.Body>
            </Modal>
