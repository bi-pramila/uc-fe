                ...
                <div className="card" id="messageList">
                    <div className="card-body">
                        <div className="flex items-center gap-3">
                            <h6 className="mb-0 grow text-15">Message <span className="inline-flex items-center justify-center size-6 text-xs font-medium border rounded rtl:mr-1 ltr:ml-1 bg-fecustom-100 border-fecustom-100 text-fecustom-500 dark:bg-fecustom-400/20 dark:border-transparent">15</span></h6>
                            <div className="shrink-0">
                                <Link to="#!" className="underline text-fecustom-500">Requests(2)</Link>
                            </div>
                        </div>
                            ...
                            <ul className="flex flex-col gap-3 mt-5 list">
                                {(data || []).map((item: any, key: number) => (<li key={key}>
                                    <Link to="#!" className="flex items-center gap-3 transition-all duration-150 ease-linear group/items">
                                        <div className="relative rounded-full size-7 bg-slate-100 dark:bg-zinc-600">
                                            <img src={item.image} alt="" className="rounded-full h-7" />
                                            <span className={`bottom-0 ltr:right-0 rtl:left-0 absolute size-2.5 border-2 border-white dark:border-zinc-500 rounded-full ${item.isActive ? "bg-green-400" : "bg-red-400"}`}></span>
                                        </div>
                                        <h6 className="transition-all duration-150 ease-linear group-hover/items:text-fecustom-500 user-name">{item.name}</h6>
                                    </Link>
                                </li>))}
                            </ul>
                        </div>
                        ...
                        <ul className="flex flex-col gap-4 mt-5">
                            {(PopularEventsData || []).map((item: any, key: number) => (<li key={key}>
                                <Link to="#!" className="flex items-center gap-3 transition-all duration-150 ease-linear group/items">
                                    ...
                                    <h6 className="transition-all duration-150 ease-linear group-hover/items:text-fecustom-500">{item.event}</h6>
                                </Link>
                            </li>))}
                        </ul>
                    </div>
                    ...
                    <div className="card-body">
                        ...
                        <ul className="flex flex-col gap-3 mt-5">
                            {(UpcomingBirthdayData || []).map((item: any, key: number) => (<li key={key}>
                                <Link to="#!" className="flex items-center gap-3 transition-all duration-150 ease-linear group/items">
                                    <div className="relative rounded-full size-9 bg-slate-100 dark:bg-zinc-600">
                                        <img src={item.image} alt="" className="rounded-full h-9" />
                                        <span className="bottom-0 ltr:right-0 rtl:left-0 absolute size-2.5 bg-green-400 border-2 border-white dark:border-zinc-500 rounded-full"></span>
                                    </div>
                                    <div className="grow">
                                        <h6 className="mb-1 transition-all duration-150 ease-linear group-hover/items:text-fecustom-500">{item.name}</h6>
