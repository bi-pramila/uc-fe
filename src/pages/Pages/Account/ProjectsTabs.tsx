    ...
    return (
        <React.Fragment>
                    ...
                    <div key={project.id} className="card">
                        <div className="card-body">
                            ...
                            <div className="mt-4">
                                ...
                                <p className="text-slate-500 dark:text-zinc-200">{project.description}</p>
                            </div>

                            <div className="flex w-full gap-3 mt-6 text-center divide-x divide-slate-200 dark:divide-zinc-500 rtl:divide-x-reverse">
                                <div className="px-3 grow">
                                    <h6 className="mb-1">{project.dueDate}</h6>
                                    <p className="text-slate-500 dark:text-zinc-200">Due Date</p>
                                </div>
                                <div className="px-3 grow">
                                    <h6 className="mb-1">{project.budget}</h6>
                                    <p className="text-slate-500 dark:text-zinc-200">Budget</p>
                                </div>
                            </div>

                            <div className="w-full h-1.5 mt-6 rounded-full bg-slate-100 dark:bg-zinc-600">
            ...
            <div className="flex flex-col items-center gap-4 mt-2 mb-4 md:flex-row">
                <div className="grow">
                    <p className="text-slate-500 dark:text-zinc-200">Showing <b>8</b> of <b>30</b> Results</p>
                </div>
