                    ...
                    <form action="#!">
                        <div className="grid grid-cols-1 gap-5 xl:grid-cols-12">
                            ...
                            <div className="xl:col-span-4">
                                ...
                                <div className="relative">
                                    <input type="password" className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" id="ConfirmpasswordInput" placeholder="Confirm password" />
                                    <button className="absolute top-2 ltr:right-4 rtl:left-4 " type="button"><i className="align-middle ri-eye-fill text-slate-500 dark:text-zinc-200"></i></button>
                                </div>
                            </div>
                            <div className="flex items-center xl:col-span-6">
                                <a href="#!" className="underline text-fecustom-500 text-13">Forgot Password ?</a>
                            </div>
