                        ...
                        <div className="card-body">
                            ...
                            <form action="#!">
                                <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-12">
                                    ...
                                    <div className="xl:col-span-6">
                                        <div>
                                            <label htmlFor="employeeId" className="inline-block mb-2 text-base font-medium">Name</label>
                                    ...
                                    <div className="xl:col-span-6">
                                        <div>
                                            <label htmlFor="remainingLeaves" className="inline-block mb-2 text-base font-medium">Email Address</label>
