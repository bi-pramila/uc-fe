                ...
                <div className="2xl:col-span-3">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <p className="mb-1 text-slate-500 dark:text-zinc-200">1235 Crossing Meadows Dr, Onalaska</p>
                            <p className="text-slate-500 dark:text-zinc-200">West Virginia, USA</p>
                        </div>
                    </div>
                </div>
                <div className="2xl:col-span-3">
                ...
                <div className="2xl:col-span-3">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <p className="mb-1 text-slate-500 dark:text-zinc-200">Payment Method: <b>Credit Card</b></p>
                            <p className="mb-1 text-slate-500 dark:text-zinc-200">Card Number: <b>xxxx xxxx xxxx 1501</b></p>
                        </div>
                    </div>
                </div>
                <div className="2xl:col-span-3">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <h6 className="mb-1">Pauline Hylton</h6>
                            <p className="mb-1 text-slate-500 dark:text-zinc-200">pauline@tailwick.com</p>
                            <p className="text-slate-500 dark:text-zinc-200">+(78) 120 4843 4714</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div>
                            <div className="card">
                                <div className="text-center card-body">
                                    ...
                                    <p className="uppercase text-slate-500 dark:text-zinc-200">Order ID</p>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div className="card">
                                <div className="text-center card-body">
                                    ...
                                    <p className="uppercase text-slate-500 dark:text-zinc-200">Order Date</p>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div className="card">
                                <div className="text-center card-body">
                                    ...
                                    <p className="uppercase text-slate-500 dark:text-zinc-200">Delivery Date</p>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div className="card">
                                <div className="text-center card-body">
                                    ...
                                    <p className="uppercase text-slate-500 dark:text-zinc-200">Order Amount</p>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div className="card">
                                <div className="text-center card-body">
                                    ...
                                    <p className="uppercase text-slate-500 dark:text-zinc-200">Order Status</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card-body">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div className="shrink-0">
                                    ...
                                    <Link to="/apps-invoice-overview" className="py-1 text-xs text-white btn bg-fecustom-500 border-fecustom-500 hover:text-white hover:bg-fecustom-600 hover:border-fecustom-600 focus:text-white focus:bg-fecustom-600 focus:border-fecustom-600 focus:ring focus:ring-fecustom-100 active:text-white active:bg-fecustom-600 active:border-fecustom-600 active:ring active:ring-fecustom-100 dark:ring-fecustom-400/20"><Download className="inline-block size-4 align-middle ltr:mr-1 rtl:ml-1" /> <span className="align-middle">Invoice</span></Link>
                                </div>
                            </div>
                            <div>
                                <div className="relative ltr:pl-6 rtl:pr-6 before:absolute ltr:before:border-l rtl:before:border-r ltr:before:left-[0.1875rem] rtl:before:right-[0.1875rem] before:border-slate-200 [&.done]:before:border-fecustom-500 before:top-1.5 before:-bottom-1.5 after:absolute after:size-2 after:bg-white after:border after:border-slate-200 after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5 pb-4 last:before:hidden [&.done]:after:bg-fecustom-500 [&.done]:after:border-fecustom-500 done">
                                    <div className="flex gap-4">
                                        <div className="grow">
                                            <h6 className="mb-2 text-gray-800 text-15 dark:text-zinc-50">Order Placed</h6>
                                            <p className="text-gray-400 dark:text-zinc-200">Your order has been successfully submitted.</p>
                                        </div>
                                        <p className="text-sm text-gray-400 dark:text-zinc-200 shrink-0">02 Nov, 2023</p>
                                    </div>
                                </div>
                                <div className="relative ltr:pl-6 rtl:pr-6 before:absolute ltr:before:border-l rtl:before:border-r ltr:before:left-[0.1875rem] rtl:before:right-[0.1875rem] before:border-slate-200 [&.done]:before:border-fecustom-500 before:top-1.5 before:-bottom-1.5 after:absolute after:size-2 after:bg-white after:border after:border-slate-200 after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5 pb-4 last:before:hidden [&.done]:after:bg-fecustom-500 [&.done]:after:border-fecustom-500 done">
                                    <div className="flex gap-4">
                                        <div className="grow">
                                            <h6 className="mb-2 text-gray-800 text-15 dark:text-zinc-50">Order Processing</h6>
                                            <p className="text-gray-400 dark:text-zinc-200">Once the order is received, it goes through the processing stage. During this time, the items are gathered, and the order is prepared for shipment.</p>
                                        </div>
                                        <p className="text-sm text-gray-400 dark:text-zinc-200 shrink-0">02 Nov, 2023</p>
                                    </div>
                                </div>
                                <div className="relative ltr:pl-6 rtl:pr-6 before:absolute ltr:before:border-l rtl:before:border-r ltr:before:left-[0.1875rem] rtl:before:right-[0.1875rem] before:border-slate-200 [&.done]:before:border-fecustom-500 before:top-1.5 before:-bottom-1.5 after:absolute after:size-2 after:bg-white after:border after:border-slate-200 after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5 pb-4 last:before:hidden [&.done]:after:bg-fecustom-500 [&.done]:after:border-fecustom-500 done">
                                    <div className="flex gap-4">
                                        <div className="grow">
                                            <h6 className="mb-2 text-gray-800 text-15 dark:text-zinc-50">Shipped Order</h6>
                                            <p className="text-gray-400 dark:text-zinc-200">The order is shipped out to the customer's designated delivery address.</p>
                                        </div>
                                        <p className="text-sm text-gray-400 dark:text-zinc-200 shrink-0">04 Nov, 2023</p>
                                    </div>
                                </div>
                                <div className="relative ltr:pl-6 rtl:pr-6 before:absolute ltr:before:border-l rtl:before:border-r ltr:before:left-[0.1875rem] rtl:before:right-[0.1875rem] before:border-slate-200 [&.done]:before:border-fecustom-500 before:top-1.5 before:-bottom-1.5 after:absolute after:size-2 after:bg-white after:border after:border-slate-200 after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5 pb-4 last:before:hidden [&.done]:after:bg-fecustom-500 [&.done]:after:border-fecustom-500 done">
                                    <div className="flex gap-4">
                                        <div className="grow">
                                            <h6 className="mb-2 text-gray-800 text-15 dark:text-zinc-50">Out for Delivery</h6>
                                            <p className="text-gray-400 dark:text-zinc-200">This status indicates that the order is currently out for delivery by the shipping or courier company.</p>
                                        </div>
                                        <p className="text-sm text-gray-400 dark:text-zinc-200 shrink-0">06 Nov, 2023</p>
                                    </div>
                                </div>
                                <div className="relative ltr:pl-6 rtl:pr-6 before:absolute ltr:before:border-l rtl:before:border-r ltr:before:left-[0.1875rem] rtl:before:right-[0.1875rem] before:border-slate-200 [&.done]:before:border-fecustom-500 before:top-1.5 before:-bottom-1.5 after:absolute after:size-2 after:bg-white after:border after:border-slate-200 after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5 pb-4 last:before:hidden [&.done]:after:bg-fecustom-500 [&.done]:after:border-fecustom-500 done">
                                    <div className="flex gap-4">
                                        <div className="grow">
                                            <h6 className="mb-2 text-gray-800 text-15 dark:text-zinc-50">Delivered</h6>
                                            <p className="text-gray-400 dark:text-zinc-200">Finally, when the order successfully reaches the customer's address and is handed over, the status changes to "Delivered."</p>
                                        </div>
                                        <p className="text-sm text-gray-400 dark:text-zinc-200 shrink-0">09 Nov, 2023</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <table className="w-full">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="px-3.5 first:pl-0 last:pr-0 py-2 border-y border-transparent"><Link to="/apps-invoice-overview" className="text-fecustom-500">#TWI154203</Link></td>
                                        </tr>
                                        <tr>
                                            <td className="px-3.5 first:pl-0 last:pr-0 py-2 border-y border-transparent">Shipping No</td>
                                            <td className="px-3.5 first:pl-0 last:pr-0 py-2 border-y border-transparent"><Link to="/#" className="text-fecustom-500">#TWS987102301</Link></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div className="card">
                        <div className="card-body">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <Link to="#!" className="underline text-fecustom-500 shrink-0">Track Order</Link>
                            </div>
                            <div className="flex gap-4">
                                <div className="shrink-0">
                                ...
                                <div className="grow">
                                    ...
                                    <p className="text-slate-500 dark:text-zinc-200">ID: EDTW1400457854</p>
                                </div>
                            </div>
                        </div>
                    </div>
