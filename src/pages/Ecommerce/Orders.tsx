...
const Orders = () => {
    ...
    const Status = ({ item }: any) => {
        switch (item) {
            ...
            case "Return":
                return (<span className="delivery_status px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-slate-100 border-slate-200 text-slate-500 dark:bg-slate-500/20 dark:border-slate-500/20 dark:text-zinc-200">{item}</span>);
            default:
                return (<span className="delivery_status px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-green-100 border-green-200 text-green-500 dark:bg-green-500/20 dark:border-green-500/20">{item}</span>);
        }
    };
    ...
    const columns = useMemo(() => [
        ...
        },
        {
            ...
            cell: (cell: any) => (
                <>
                    <Link to="#!" className="transition-all duration-150 ease-linear order_id text-fecustom-500 hover:text-fecustom-600">{cell.getValue()}</Link>
                </>
            ),
        },
        {
            ...
            <div className="grid grid-cols-1 gap-x-5 md:grid-cols-2 2xl:grid-cols-12">
                <div className="2xl:col-span-2 2xl:row-span-1">
                    <div className="card">
                        <div className="flex items-center gap-3 card-body">
                            <div className="flex items-center justify-center size-12 rounded-md text-15 bg-fecustom-50 text-fecustom-500 dark:bg-fecustom-500/20 shrink-0"><Boxes /></div>
                            <div className="grow">
                    ...
                    <div className="card">
                        <div className="flex items-center gap-3 card-body">
                            ...
                            <div className="grow">
                                ...
                                <p className="text-slate-500 dark:text-zinc-200">New Orders</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="order-last md:col-span-2 2xl:col-span-8 2xl:row-span-3 card 2xl:order-none">
                    <div className="card-body">
                        <h6 className="mb-4 text-gray-800 text-15 dark:text-zinc-50">Orders Overview</h6>
                    ...
                    <div className="card">
                        <div className="flex items-center gap-3 card-body">
                            ...
                            <div className="grow">
                                ...
                                <p className="text-slate-500 dark:text-zinc-200">Pending Orders</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="card">
                        <div className="flex items-center gap-3 card-body">
                            ...
                            <div className="grow">
                                ...
                                <p className="text-slate-500 dark:text-zinc-200">Shipping Orders</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="card">
                        <div className="flex items-center gap-3 card-body">
                            ...
                            <div className="grow">
                                ...
                                <p className="text-slate-500 dark:text-zinc-200">Delivered Orders</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="card">
                        <div className="flex items-center gap-3 card-body">
                            ...
                            <div className="grow">
                                ...
                                <p className="text-slate-500 dark:text-zinc-200">Cancelled Orders</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="card-body">
                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-2 lg:col-start-11">
                            <div className="ltr:lg:text-right rtl:lg:text-left">
                                <Link to="#!" data-modal-target="addOrderModal" type="button" className="text-white btn bg-fecustom-500 border-fecustom-500 hover:text-white hover:bg-fecustom-600 hover:border-fecustom-600 focus:text-white focus:bg-fecustom-600 focus:border-fecustom-600 focus:ring focus:ring-fecustom-100 active:text-white active:bg-fecustom-600 active:border-fecustom-600 active:ring active:ring-fecustom-100 dark:ring-fecustom-400/20" onClick={toggle}>
                    ...
                    <ul className="flex flex-wrap w-full mt-5 text-sm font-medium text-center text-gray-500 nav-tabs">
                        <li className={`group ${activeTab === "1" && "active"}`}>
                            <Link to="#" data-tab-toggle data-target="allOrders" className="inline-block px-4 py-1.5 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 dark:text-zinc-200 border border-transparent group-[.active]:bg-fecustom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-fecustom-500 dark:hover:text-fecustom-500 active:text-fecustom-500 dark:active:text-fecustom-500 -mb-[1px]" onClick={() => { toggleTab("1", "all"); }}>
                        ...
                        <li className={`group ${activeTab === "2" && "active"}`}>
                            <Link to="#" data-tab-toggle data-target="pendingOrder" className="inline-block px-4 py-1.5 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 dark:text-zinc-200 border border-transparent group-[.active]:bg-fecustom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-fecustom-500 dark:hover:text-fecustom-500 active:text-fecustom-500 dark:active:text-fecustom-500 -mb-[1px]" onClick={() => { toggleTab("2", "Pending"); }}>
                        ...
                        <li className={`group ${activeTab === "3" && "active"}`}>
                            <Link to="#" data-tab-toggle data-target="deliveredOrder" className="inline-block px-4 py-1.5 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 dark:text-zinc-200 border border-transparent group-[.active]:bg-fecustom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-fecustom-500 dark:hover:text-fecustom-500 active:text-fecustom-500 dark:active:text-fecustom-500 -mb-[1px]" onClick={() => { toggleTab("3", "Delivered"); }}>
                        ...
                        <li className={`group ${activeTab === "4" && "active"}`}>
                            <Link to="#" data-tab-toggle data-target="returnsOrders" className="inline-block px-4 py-1.5 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 dark:text-zinc-200 border border-transparent group-[.active]:bg-fecustom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-fecustom-500 dark:hover:text-fecustom-500 active:text-fecustom-500 dark:active:text-fecustom-500 -mb-[1px]" onClick={() => { toggleTab("4", "Return"); }}>
                        ...
                        <li className={`group ${activeTab === "5" && "active"}`}>
                            <Link to="#" data-tab-toggle data-target="cancelledOrders" className="inline-block px-4 py-1.5 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 dark:text-zinc-200 border border-transparent group-[.active]:bg-fecustom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-fecustom-500 dark:hover:text-fecustom-500 active:text-fecustom-500 dark:active:text-fecustom-500 -mb-[1px]" onClick={() => { toggleTab("5", "Cancelled"); }}>
                    ...
                    {data && data.length > 0 ?
                        <TableContainer
                            ...
                            thclassName="px-3.5 py-2.5 font-semibold text-slate-500 border-b border-slate-200 dark:border-zinc-500 dark:text-zinc-200"
                    ...
                    <form action="#!" onSubmit={(e) => {
                        ...
                        <div className="grid grid-cols-1 gap-4 xl:grid-cols-12">
                            <div className="xl:col-span-12">
                                ...
                                <input type="text" id="orderId" className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" disabled value={validation.values.orderId || "#TWT5015100365"} required />
                            </div>
                            ...
                            <div className="xl:col-span-12">
                                ...
                                <input type="text" id="customerNameInput" className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Customer name"
                                    name="customerName"
                            ...
                            <div className="xl:col-span-12">
                                ...
                                <select className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" data-choices data-choices-search-false id="deliveryStatusSelect"
                                    name="deliveryStatus"
                                    onChange={validation.handleChange}
