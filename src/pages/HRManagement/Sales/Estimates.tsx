        ...
        },
        {
            ...
            cell: (cell: any) => (
                <Dropdown className="relative">
                    ...
                    <Dropdown.Content placement={cell.row.index ? "top-end" : "right-end"} className="absolute z-50 py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zinc-600" aria-labelledby="estimateAction4">
                        <li>
                    ...
                    <div className="grid grid-cols-1 gap-4 mb-5 lg:grid-cols-2 xl:grid-cols-12">
                        ...
                        <div className="xl:col-span-2 xl:col-start-11">
                            <div className="lg:ltr:text-right lg:rtl:text-left">
                                <Link to="#!" data-modal-target="addEstimateModal" type="buton" className="text-white btn bg-fecustom-500 border-fecustom-500 hover:text-white hover:bg-fecustom-600 hover:border-fecustom-600 focus:text-white focus:bg-fecustom-600 focus:border-fecustom-600 focus:ring focus:ring-fecustom-100 active:text-white active:bg-fecustom-600 active:border-fecustom-600 active:ring active:ring-fecustom-100 dark:ring-fecustom-400/20" onClick={toggle}>
                    ...
                    <form action="#!" onSubmit={(e) => {
                        ...
                        <div className="grid grid-cols-1 gap-4 xl:grid-cols-12">
                            <div className="xl:col-span-12">
                                ...
                                <input type="text" id="estimateInput" className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Estimate Number" disabled
                            ...
                            <div className="xl:col-span-12">
                                ...
                                <input type="text" id="clientNameInput" className="form-input border-slate-200 dark:border-zinc-500 focus:outline-none focus:border-fecustom-500 disabled:bg-slate-100 dark:disabled:bg-zinc-600 disabled:border-slate-300 dark:disabled:border-zinc-500 dark:disabled:text-zinc-200 disabled:text-slate-500 dark:text-zinc-100 dark:bg-zinc-700 dark:focus:border-fecustom-800 placeholder:text-slate-400 dark:placeholder:text-zinc-200" placeholder="Client name"
                                    name="clientName"
                            ...
                            <div className="xl:col-span-12">
                                ...
                                <select className="form-input border-slate-200 focus:outline-none focus:border-fecustom-500" data-choices data-choices-search-false id="estimateBySelect"
                                    name="estimateBy"
                                    onChange={validation.handleChange}
                            ...
                            <div className="xl:col-span-12">
                                ...
                                <select className="form-input border-slate-200 focus:outline-none focus:border-fecustom-500" data-choices data-choices-search-false id="statusSelect"
                                    name="status"
                                    onChange={validation.handleChange}
