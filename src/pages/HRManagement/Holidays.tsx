        ...
        },
        {
            ...
            cell: (cell: any) => (
                <div className="flex gap-2">
                    ...
                    <Link to="#!" className="flex items-center justify-center size-8 transition-all duration-200 ease-linear rounded-md bg-slate-100 text-slate-500 hover:text-red-500 hover:bg-red-100 dark:bg-zinc-600 dark:text-zinc-200 dark:hover:text-red-500 dark:hover:bg-red-500/20" onClick={() => {
                        const data = cell.row.original;
                        onClickDelete(data);
                ...
                <div className="card-body">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div className="shrink-0">
                            <Link to="#!" data-modal-target="addHolidayModal" type="button" className="text-white btn bg-fecustom-500 border-fecustom-500 hover:text-white hover:bg-fecustom-600 hover:border-fecustom-600 focus:text-white focus:bg-fecustom-600 focus:border-fecustom-600 focus:ring focus:ring-fecustom-100 active:text-white active:bg-fecustom-600 active:border-fecustom-600 active:ring active:ring-fecustom-100 dark:ring-fecustom-400/20" onClick={toggle}>
                    ...
                    {data && data.length > 0 ?
                        ...
                        (<div className="noresult">
                            <div className="py-6 text-center">
                                ...
                                <p className="mb-0 text-slate-500 dark:text-zinc-200">We've searched more than 10+ Holidays We did not find any Holidays for you search.</p>
                            </div>
                        </div>)}
                </div>
            </div>
