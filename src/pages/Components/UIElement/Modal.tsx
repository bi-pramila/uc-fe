                    ...
                    <div className="card-body">
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <Modal show={defaultModal} onHide={defaultToggle} id="defaultModal" modal-center="true"
                                ...
                                <Modal.Footer className="flex items-center justify-between p-4 mt-auto border-t border-slate-200 dark:border-zinc-500">
                            ...
                            <Modal show={topModal} onHide={topToggle} id="topModal" modal-top="true" className="fixed flex flex-col transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4"
                                dialogClassName="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zinc-600 flex flex-col">
                                <Modal.Header className="flex items-center justify-between p-4 border-b border-slate-200 dark:border-zinc-500"
                                    closeButtonClass="transition-all duration-200 ease-linear text-slate-500 hover:text-red-500 dark:text-zinc-200 dark:hover:text-red-500">
                                    <Modal.Title className="text-16">Modal Heading</Modal.Title>
                                </Modal.Header>
                    ...
                    <div className="card-body">
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <Modal show={extraSmallModal} onHide={extraSmallToggle} id="extraSmallModal" modal-center="true"
                                className="fixed flex flex-col transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4"
                                dialogClassName="w-screen md:w-[20rem] bg-white shadow rounded-md dark:bg-zinc-600 flex flex-col h-full">
                                <Modal.Header className="flex items-center justify-between p-4 border-b border-slate-200 dark:border-zinc-500"
                                    closeButtonClass="transition-all duration-200 ease-linear text-slate-500 hover:text-red-500 dark:text-zinc-200 dark:hover:text-red-500">
                                    <Modal.Title className="text-16">Modal Heading</Modal.Title>
                                </Modal.Header>
                            ...
                            <Modal show={smallModal} onHide={smallToggle} id="smallModal" modal-center="true"
                                className="fixed flex flex-col transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4"
                                dialogClassName="w-screen md:w-[25rem] bg-white shadow rounded-md dark:bg-zinc-600 flex flex-col h-full">
                                <Modal.Header className="flex items-center justify-between p-4 border-b border-slate-200 dark:border-zinc-500"
                                    closeButtonClass="transition-all duration-200 ease-linear text-slate-500 hover:text-red-500 dark:text-zinc-200 dark:hover:text-red-500">
                                    <Modal.Title className="text-16">Modal Heading</Modal.Title>
                                </Modal.Header>
                            ...
                            <Modal show={extraLargeModal} onHide={extraLargeToggle} id="extraLargeModal" modal-center="true"
                                className="fixed flex flex-col transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4"
                                dialogClassName="w-screen lg:w-[55rem] bg-white shadow rounded-md dark:bg-zinc-600 flex flex-col h-full">
                                <Modal.Header className="flex items-center justify-between p-4 border-b border-slate-200 dark:border-zinc-500"
                                    closeButtonClass="transition-all duration-200 ease-linear text-slate-500 hover:text-red-500 dark:text-zinc-200 dark:hover:text-red-500">
                                    <Modal.Title className="text-16">Modal Heading</Modal.Title>
                                </Modal.Header>
                            ...
                            <Modal show={fullScreenModal} onHide={fullScreenToggle} id="fullScreenModal" modal-center="true"
                                ...
                                dialogClassName="flex flex-col w-full h-full bg-white dark:bg-zinc-600">
                                <Modal.Header className="flex items-center justify-between p-4 border-b border-slate-200 dark:border-zinc-500"
                                    closeButtonClass="transition-all duration-200 ease-linear text-slate-500 hover:text-red-500 dark:text-zinc-200 dark:hover:text-red-500">
                                    <Modal.Title className="text-16">Modal Heading</Modal.Title>
                                </Modal.Header>
