                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="flex flex-wrap items-center gap-2">
                                <div className="inline-block size-8 border-2 rounded-full animate-spin border-l-transparent border-fecustom-500"></div>
                                ...
                                <div className="inline-block size-8 border-2 rounded-full animate-spin border-l-transparent border-slate-400 dark:border-zinc-500 dark:border-l-transparent"></div>
                                <div className="inline-block size-8 border-2 rounded-full animate-spin border-l-transparent border-slate-900 dark:border-zinc-200 dark:border-l-transparent"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="flex flex-wrap items-center gap-5 px-3 py-2">
                                <div className="inline-flex size-4 rounded-full opacity-75 animate-ping bg-fecustom-500"></div>
                                ...
                                <div className="inline-flex size-4 rounded-full opacity-75 animate-ping bg-slate-900 dark:bg-zinc-300"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="card">
                    <div className="card-body">
                        ...
                        <div className="flex flex-wrap items-center gap-5">
                            <div className="inline-flex size-6 rounded-full opacity-75 animate-bounce bg-fecustom-500"></div>
                            ...
                            <div className="inline-flex size-6 rounded-full opacity-75 animate-bounce bg-slate-900 dark:bg-zinc-300"></div>
                        </div>
                    </div>
                </div>
                <div className="card">
                    <div className="card-body">
                        ...
                        <div className="grid grid-cols-1 gap-5 xl:grid-cols-3">
                            <div className="flex flex-wrap items-center gap-5">
                                <div className="inline-block size-4 border-2 rounded-full animate-spin border-l-transparent border-fecustom-500"></div>
                                <div className="inline-block size-6 border-2 rounded-full animate-spin border-l-transparent border-fecustom-500"></div>
                                <div className="inline-block size-8 border-2 rounded-full animate-spin border-l-transparent border-fecustom-500"></div>
                                <div className="inline-block size-10 border-2 rounded-full animate-spin border-l-transparent border-fecustom-500"></div>
                            </div>
                            <div className="flex flex-wrap items-center gap-6">
                                <div className="inline-flex size-4 rounded-full opacity-75 animate-bounce bg-fecustom-500"></div>
                                <div className="inline-flex size-6 rounded-full opacity-75 animate-bounce bg-fecustom-500"></div>
                                <div className="inline-flex size-8 rounded-full opacity-75 animate-bounce bg-fecustom-500"></div>
                                <div className="inline-flex size-10 rounded-full opacity-75 animate-bounce bg-fecustom-500"></div>
                            </div>
                            <div className="flex flex-wrap items-center gap-6">
                                <div className="inline-flex size-2 rounded-full opacity-75 animate-ping bg-fecustom-500"></div>
                                <div className="inline-flex size-4 rounded-full opacity-75 animate-ping bg-fecustom-500"></div>
                                <div className="inline-flex size-6 rounded-full opacity-75 animate-ping bg-fecustom-500"></div>
                                <div className="inline-flex size-8 rounded-full opacity-75 animate-ping bg-fecustom-500"></div>
                            </div>
                        </div>
                    </div>
                </div>
