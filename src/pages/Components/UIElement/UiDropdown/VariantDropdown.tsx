                ...
                <div className="card-body">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        <Dropdown className="relative">
                            <Dropdown.Trigger type="button" className="text-white dropdown-toggle btn bg-fecustom-500 border-fecustom-500 hover:text-white hover:bg-fecustom-600 hover:border-fecustom-600 focus:text-white focus:bg-fecustom-600 focus:border-fecustom-600 focus:ring focus:ring-fecustom-100 active:text-white active:bg-fecustom-600 active:border-fecustom-600 active:ring active:ring-fecustom-100 dark:ring-fecustom-400/20" id="dropdownColor1" data-bs-toggle="dropdown">
                                Custom Dropdown <ChevronDown className="inline-block size-4 ltr:ml-1 rtl:mr-1"></ChevronDown>
                            </Dropdown.Trigger>

                            <Dropdown.Content placement="right-end" as='ul' className="absolute z-50 py-2 mt-1 list-none bg-white rounded-md shadow-md ltr:text-left rtl:text-right dropdown-menu min-w-max dark:bg-zinc-600" aria-labelledby="dropdownColor1">
                                <li>
                                    <a className="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-fecustom-500 dropdown-item hover:bg-fecustom-50 hover:text-fecustom-600 focus:bg-fecustom-50 focus:text-fecustom-600 dark:text-fecustom-500 dark:hover:bg-fecustom-500/20 dark:hover:text-fecustom-500 dark:focus:bg-fecustom-500/20 dark:focus:text-fecustom-500" href="#!">Action</a>
                                </li>
                                <li>
                                    <a className="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-fecustom-500 dropdown-item hover:bg-fecustom-50 hover:text-fecustom-600 focus:bg-fecustom-50 focus:text-fecustom-600 dark:text-fecustom-500 dark:hover:bg-fecustom-500/20 dark:hover:text-fecustom-500 dark:focus:bg-fecustom-500/20 dark:focus:text-fecustom-500" href="#!">Another action</a>
                                </li>
                                <li>
                                    <a className="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-fecustom-500 dropdown-item hover:bg-fecustom-50 hover:text-fecustom-600 focus:bg-fecustom-50 focus:text-fecustom-600 dark:text-fecustom-500 dark:hover:bg-fecustom-500/20 dark:hover:text-fecustom-500 dark:focus:bg-fecustom-500/20 dark:focus:text-fecustom-500" href="#!">Something else here</a>
                                </li>
                                <li className="pt-2 mt-2 border-t border-slate-200 dark:border-zinc-500">
                                    <a className="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-fecustom-500 dropdown-item hover:bg-fecustom-50 hover:text-fecustom-600 focus:bg-fecustom-50 focus:text-fecustom-600 dark:text-fecustom-500 dark:hover:bg-fecustom-500/20 dark:hover:text-fecustom-500 dark:focus:bg-fecustom-500/20 dark:focus:text-fecustom-500" href="#!">Your Link</a>
                                </li>
                            </Dropdown.Content>
                        </Dropdown>
                        ...
                        <Dropdown className="relative">
                            ...
                            <Dropdown.Content placement="right-end" as='ul' className="absolute z-50 py-2 mt-1 list-none bg-white rounded-md shadow-md ltr:text-left rtl:text-right dropdown-menu min-w-max dark:bg-zinc-600" aria-labelledby="dropdownColor2">
                                <li>
                        ...
                        <Dropdown className="relative">
                            ...
                            <Dropdown.Content placement="right-end" as='ul' className="absolute z-50 py-2 mt-1 list-none bg-white rounded-md shadow-md ltr:text-left rtl:text-right dropdown-menu min-w-max dark:bg-zinc-600" aria-labelledby="dropdownColor3">
                                <li>
                        ...
                        <Dropdown className="relative">
                            ...
                            <Dropdown.Content placement="right-end" as='ul' className="absolute z-50 py-2 mt-1 list-none bg-white rounded-md shadow-md ltr:text-left rtl:text-right dropdown-menu min-w-max dark:bg-zinc-600" aria-labelledby="dropdownColor4">
                                <li>
                        ...
                        <Dropdown className="relative">
                            ...
                            <Dropdown.Content placement="right-end" as='ul' className="absolute z-50 py-2 mt-1 list-none bg-white rounded-md shadow-md ltr:text-left rtl:text-right dropdown-menu min-w-max dark:bg-zinc-600" aria-labelledby="dropdownColor5">
                                <li>
