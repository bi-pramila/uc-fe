    ...
    return (
        <React.Fragment>
            ...
            <div className="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
                <div className="card bg-fecustom-100 border-fecustom-200 dark:bg-fecustom-400/20 dark:border-fecustom-600">
                    <div className="card-body">
                        <h6 className="mb-4 text-fecustom-500 dark:text-fecustom-200 text-15">
                            Custom Card
                        </h6>
                        <p className="mb-4 text-fecustom-400">
                            With supporting text below as a natural lead-in to additional content.
                        </p>
                        <a className="inline-flex items-center gap-2 text-sm font-medium transition-all duration-200 ease-linear text-fecustom-400 hover:text-fecustom-600" href="#!">
