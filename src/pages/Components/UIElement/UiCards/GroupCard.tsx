    ...
    return (
        <React.Fragment>
            ...
            <div className="grid overflow-hidden border sm:flex card">
                <div className="flex flex-col flex-[1_0_0%] rtl:border-b rtl:sm:border-b-0 ltr:border-r rtl:sm:border-l border-slate-200 dark:border-zinc-500">
                    ...
                    <div className="border-t card-body border-slate-200 dark:border-zinc-500">
                        <p className="text-xs">
