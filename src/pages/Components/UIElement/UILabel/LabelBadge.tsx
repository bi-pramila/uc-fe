                ...
                <div className="card">
                    <div className="card-body">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            <span className="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-fecustom-100 border-transparent text-fecustom-500 dark:bg-fecustom-500/20 dark:border-transparent"><Frown className="size-3 ltr:mr-1 rtl:ml-1"></Frown> Custom</span>
                            ...
                            <span className="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-slate-100 border-transparent text-slate-500 dark:bg-slate-500/20 dark:text-zinc-200 dark:border-transparent"><Frown className="size-3 ltr:mr-1 rtl:ml-1"></Frown> Slate</span>
                        </div>
                    </div>
                </div>
                <div className="card">
                    <div className="card-body">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            <span className="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-white border-fecustom-400 text-fecustom-500 dark:bg-zinc-700 dark:border-fecustom-700">
                                <span className="size-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-fecustom-500"></span> Custom
                            </span>
                            <span className="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-white border-green-400 text-green-500 dark:bg-zinc-700 dark:border-green-700">
                                <span className="size-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-green-500"></span> Green
                            </span>
                            <span className="flex items-center px-2.5 py-0.5 text-xs font-medium rounded-full border bg-white border-orange-400 text-orange-500 dark:bg-zinc-700 dark:border-orange-700">
                                <span className="size-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-orange-500"></span> Orange
                            </span>
                            <span className="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-white border-sky-400 text-sky-500 dark:bg-zinc-700 dark:border-sky-700">
                                <span className="size-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-sky-500"></span> Sky
                            </span>
                            <span className="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-white border-yellow-400 text-yellow-500 dark:bg-zinc-700 dark:border-yellow-700">
                                <span className="size-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-yellow-500"></span> Yellow
                            </span>
                            <span className="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-white border-red-400 text-red-500 dark:bg-zinc-700 dark:border-red-700">
                                <span className="size-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-red-500"></span> Red
                            </span>
                            <span className="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-white border-purple-400 text-purple-500 dark:bg-zinc-700 dark:border-purple-700">
                                <span className="size-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-purple-500"></span> Purple
                            </span>
                            <span className="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-white border-slate-400 text-slate-500 dark:bg-zinc-700 dark:border-zinc-400 dark:text-zinc-200">
            ...
            <div className="grid grid-cols-1 gap-x-5 xl:grid-cols-2">
                <div className="card">
                    <div className="card-body">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            <span className="flex items-center justify-center size-8 text-xs font-medium border border-transparent rounded bg-fecustom-100 text-fecustom-500 dark:bg-fecustom-500/20 dark:border-transparent"><Gift className="size-3"></Gift></span>
                ...
                <div className="card">
                    <div className="card-body">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            <button type="button" className="relative flex items-center justify-center text-white btn bg-fecustom-500 border-fecustom-500 hover:text-white hover:bg-fecustom-600 hover:border-fecustom-600 focus:text-white focus:bg-fecustom-600 focus:border-fecustom-600 focus:ring focus:ring-fecustom-100 active:text-white active:bg-fecustom-600 active:border-fecustom-600 active:ring active:ring-fecustom-100 dark:ring-fecustom-400/20">
                                Custom Button
                                <span className="flex items-center justify-center size-5 ltr:ml-2 rtl:mr-2 text-[10px] shrink-0 font-medium border rounded-full bg-fecustom-400 border-fecustom-400">15</span>
                            </button>
                            <button type="button" className="flex items-center justify-center size-[37.5px] relative p-0 text-white btn bg-fecustom-500 border-fecustom-500 hover:text-white hover:bg-fecustom-600 hover:border-fecustom-600 focus:text-white focus:bg-fecustom-600 focus:border-fecustom-600 focus:ring focus:ring-fecustom-100 active:text-white active:bg-fecustom-600 active:border-fecustom-600 active:ring active:ring-fecustom-100 dark:ring-fecustom-400/20">
            ...
            <div className="grid grid-cols-1 gap-x-5 xl:grid-cols-2">
                <div className="card">
                    <div className="card-body">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            <a href="#!" className="px-2.5 py-0.5 text-xs font-medium inline-block rounded border transition-all duration-200 ease-linear bg-fecustom-100 border-transparent text-fecustom-500 hover:bg-fecustom-200 dark:bg-fecustom-400/20 dark:hover:bg-fecustom-400/30 dark:border-transparent">Custom</a>
                            ...
                            <a href="#!" className="px-2.5 py-0.5 text-xs font-medium inline-block rounded border transition-all duration-200 ease-linear bg-slate-100 border-transparent text-slate-500 hover:bg-slate-200 dark:text-zinc-200 dark:bg-slate-400/20 dark:hover:bg-slate-400/30 dark:border-transparent">Slate</a>
                        </div>
                    </div>
                </div>
            </div>
