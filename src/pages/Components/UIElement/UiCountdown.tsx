                ...
                <div>
                        ...
                        <div className="card-body">
                            ...
                            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
                                <div className="text-center">
                                    ...
                                    <p className="mb-0 text-slate-500 dark:text-zinc-200">Working Hours</p>
                                </div>
                                <div className="text-center text-fecustom-500">
                                    <h4 className="mb-2 fs-4xl "><CountUp className="counter-value" end={365} /></h4>
                                    <p className="mb-0 text-fecustom-500">Completed Projects</p>
                                </div>
                                <div className="text-center">
                                    <h4 className="mb-2 fs-4xl"><CountUp className="counter-value" end={4645} /></h4>
                                    <p className="mb-0 text-slate-500 dark:text-zinc-200">Happy Users & Clients</p>
                                </div>
                                <div className="text-center">
                                    <h4 className="mb-2 fs-4xl"><CountUp className="counter-value" end={130} /></h4>
                                    <p className="mb-0 text-slate-500 dark:text-zinc-200">Awards Received</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card-body">
                            ...
                            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
                                <div className="text-center">
                                    ...
                                    <p className="mb-0 text-slate-500 dark:text-zinc-200">Total Earnings</p>
                                </div>
                                <div className="text-center">
                                    <h4 className="mb-2 fs-4xl"><CountUp end={54.41} decimals={2} />k</h4>
                                    <p className="mb-0 text-slate-500 dark:text-zinc-200">Total Orders</p>
                                </div>
                                <div className="text-center">
                                    <h4 className="mb-2 fs-4xl"><CountUp end={4645} /></h4>
                                    <p className="mb-0 text-slate-500 dark:text-zinc-200">Customers</p>
                                </div>
                                <div className="text-center">
                                    <h4 className="mb-2 fs-4xl">$<CountUp end={165.89} decimals={2} />k</h4>
                                    <p className="mb-0 text-slate-500 dark:text-zinc-200">My Balance</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
                                <div className="px-3 py-6 text-center border rounded-md border-slate-200 dark:border-zinc-500">
                    ...
                    <div className="card">
                        <div className="card-body">
                            <h6 className="mb-4 text-gray-800 text-15 dark:text-zinc-50">Counter with Icons</h6>
                            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
                                <div className="px-3 py-6 text-center border rounded-md dark:border-zinc-500 border-slate-200">
                                    <div className="flex items-center justify-center size-12 mx-auto mb-4 rounded-md text-15 bg-fecustom-50 dark:bg-fecustom-500/20">
                                        <Smile className="text-fecustom-500 fill-fecustom-200 dark:fill-fecustom-500/30"></Smile></div>
                                    <h4 className="mb-2 fs-4xl"><CountUp className="counter-value" end={8000} />k</h4>
                                    <p className="mb-0 text-slate-500 dark:text-zinc-200">Happy Clients</p>
                                </div>
                                <div className="px-3 py-6 text-center border rounded-md dark:border-zinc-500 border-slate-200">
                                    ...
                                    <p className="mb-0 text-slate-500 dark:text-zinc-200">Downloads</p>
                                </div>
                                <div className="px-3 py-6 text-center border rounded-md dark:border-zinc-500 border-slate-200">
                                    ...
                                    <p className="mb-0 text-slate-500 dark:text-zinc-200">Project Completed</p>
                                </div>
                                <div className="px-3 py-6 text-center border rounded-md dark:border-zinc-500 border-slate-200">
                                    ...
                                    <h4 className="mb-2 fs-4xl"><CountUp className="counter-value" end={365} /></h4>
                                    <p className="mb-0 text-slate-500 dark:text-zinc-200">Working Days</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
                                <div className="px-3 py-6 text-center border rounded-md border-fecustom-200 dark:border-zinc-500">
                                    <div className="flex items-center justify-center size-12 mx-auto mb-4 rounded-md text-15 bg-fecustom-50 dark:bg-fecustom-400/20">
                                        <Smile className="text-fecustom-500 fill-fecustom-200 dark:fill-fecustom-500/20"></Smile></div>
                                ...
                                <div className="px-3 py-6 text-center bg-green-100 border border-green-100 rounded-md dark:bg-green-900 dark:border-zinc-800">
                                ...
                                <div className="px-3 py-6 text-center border rounded-md bg-sky-500 border-sky-500 dark:bg-sky-900 dark:border-zinc-800">
