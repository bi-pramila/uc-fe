            ...
            <div className="card">
                <div className="card-body">
                    ...
                    <TableContainer
                        ...
                        thclassName="ltr:!text-left rtl:!text-right p-3 group-[.bordered]:border group-[.bordered]:border-slate-200 group-[.bordered]:dark:border-zinc-500 sorting px-3 py-4 text-slate-900 bg-slate-200/50 font-semibold text-left dark:text-zinc-50 dark:bg-zinc-600 dark:group-[.bordered]:border-zinc-500 sorting_asc"
