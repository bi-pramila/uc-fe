            ...
            <section className="relative pb-32" id="pricing">
                <div className="container 2xl:max-w-[87.5rem] px-4 mx-auto">
                    <div className="mx-auto text-center xl:max-w-3xl">
                        ...
                        <p className="text-lg text-slate-500 dark:text-zinc-200">A good web design package will include designing a logo, ingratiation with local SEO, linking a site to a social media presence, and more.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 mt-16 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
                        <div className="!shadow-lg text-15 card">
                            <div className="card-body">
                                ...
                                <p className="mb-4 text-slate-500 dark:text-zinc-200">Perfect plan for Lite</p>

                                <h1 className="mb-4 font-normal"><span className="text-slate-400 dark:text-zinc-200">$</span>9.99<small className="text-15 text-slate-500 dark:text-zinc-200">/Monthly</small></h1>
                                <button type="button" className="w-full bg-white border-dashed text-fecustom-500 btn border-fecustom-500 hover:text-fecustom-500 hover:bg-fecustom-50 hover:border-fecustom-600 focus:text-fecustom-600 focus:bg-fecustom-50 focus:border-fecustom-600 active:text-fecustom-600 active:bg-fecustom-50 active:border-fecustom-600 dark:bg-zinc-700 dark:ring-fecustom-400/20 dark:hover:bg-fecustom-800/20 dark:focus:bg-fecustom-800/20 dark:active:bg-fecustom-800/20">Purchase Now</button>
                                <ul className="flex flex-col gap-3 mt-5">
                                    ...
                                    <li className="flex items-center gap-2 line-through text-slate-500 dark:text-zinc-200">
                        ...
                        <div className="!shadow-lg text-15 card">
                            <div className="card-body">
                                ...
                                <p className="mb-4 text-slate-500 dark:text-zinc-200">For users who want to do more.</p>

                                <h1 className="mb-4 font-normal"><span className="text-slate-400 dark:text-zinc-200">$</span>29.99<small className="text-15 text-slate-500 dark:text-zinc-200">/Monthly</small></h1>
                                <button type="button" className="w-full bg-white border-dashed text-fecustom-500 btn border-fecustom-500 hover:text-fecustom-500 hover:bg-fecustom-50 hover:border-fecustom-600 focus:text-fecustom-600 focus:bg-fecustom-50 focus:border-fecustom-600 active:text-fecustom-600 active:bg-fecustom-50 active:border-fecustom-600 dark:bg-zinc-700 dark:ring-fecustom-400/20 dark:hover:bg-fecustom-800/20 dark:focus:bg-fecustom-800/20 dark:active:bg-fecustom-800/20">Purchase Now</button>
                                <ul className="flex flex-col gap-3 mt-5">
                                    <li className="flex items-center gap-2">
                                        <CheckCheck className="inline-block size-4 text-green-500 fill-green-100 dark:fill-green-500/20"></CheckCheck>
                        ...
                        <div className="relative overflow-hidden card !shadow-lg text-15">
                            <div className="card-body">
                                ...
                                <p className="mb-4 text-slate-500 dark:text-zinc-200">Run your company on your teams</p>

                                <h1 className="mb-4 font-normal"><span className="text-slate-400 dark:text-zinc-200">$</span>39.99<small className="text-15 text-slate-500 dark:text-zinc-200">/Monthly</small></h1>
                                <button type="button" className="w-full bg-white border-dashed text-fecustom-500 btn border-fecustom-500 hover:text-fecustom-500 hover:bg-fecustom-50 hover:border-fecustom-600 focus:text-fecustom-600 focus:bg-fecustom-50 focus:border-fecustom-600 active:text-fecustom-600 active:bg-fecustom-50 active:border-fecustom-600 dark:bg-zinc-700 dark:ring-fecustom-400/20 dark:hover:bg-fecustom-800/20 dark:focus:bg-fecustom-800/20 dark:active:bg-fecustom-800/20">Purchase Now</button>
                                <ul className="flex flex-col gap-3 mt-5">
                                    <li className="flex items-center gap-2">
                                        <CheckCheck className="inline-block size-4 text-green-500 fill-green-100 dark:fill-green-500/20"></CheckCheck>
                        ...
                        <div className="!shadow-lg text-15 card">
                            <div className="card-body">
                                ...
                                <p className="mb-4 text-slate-500 dark:text-zinc-200">Your entire team in one place</p>

                                <h1 className="mb-4 font-normal"><span className="text-slate-400 dark:text-zinc-200">$</span>49.99<small className="text-15 text-slate-500 dark:text-zinc-200">/Monthly</small></h1>
                                <button type="button" className="w-full bg-white border-dashed text-fecustom-500 btn border-fecustom-500 hover:text-fecustom-500 hover:bg-fecustom-50 hover:border-fecustom-600 focus:text-fecustom-600 focus:bg-fecustom-50 focus:border-fecustom-600 active:text-fecustom-600 active:bg-fecustom-50 active:border-fecustom-600 dark:bg-zinc-700 dark:ring-fecustom-400/20 dark:hover:bg-fecustom-800/20 dark:focus:bg-fecustom-800/20 dark:active:bg-fecustom-800/20">Purchase Now</button>
                                <ul className="flex flex-col gap-3 mt-5">
                                    <li className="flex items-center gap-2">
                                        <CheckCheck className="inline-block size-4 text-green-500 fill-green-100 dark:fill-green-500/20"></CheckCheck>
