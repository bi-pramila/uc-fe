    ...
    return (
        <React.Fragment>
            <section className="relative pb-36 pt-44" id="home">
                <div className="absolute rotate-45 border border-dashed size-[500px] border-t-slate-300 dark:border-t-zinc-500 border-l-slate-300 dark:border-l-zinc-500 border-r-slate-700 dark:border-r-zinc-400 border-b-slate-700 dark:border-b-zinc-400 -bottom-[250px] rounded-full ltr:right-40 rtl:left-40 z-10 hidden lg:block"></div>
                <div className="absolute rotate-45 border border-dashed size-[700px] border-t-slate-300 dark:border-t-zinc-500 border-l-slate-300 dark:border-l-zinc-500 border-r-slate-700 dark:border-r-zinc-400 border-b-slate-700 dark:border-b-zinc-400 -bottom-[350px] rounded-full ltr:right-16 rtl:left-16 z-10 hidden 2xl:block"></div>
