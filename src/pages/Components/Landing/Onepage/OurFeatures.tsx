        ...
        <React.Fragment>
            <section className="relative py-32 bg-slate-900 dark:bg-zinc-700" id="features">
                <div className="container 2xl:max-w-[87.5rem] px-4 mx-auto">
                    ...
                    <div className="mt-24">
                        <h1 className="mb-16 leading-normal capitalize text-slate-100 dark:text-zinc-50">Build for anyone who works with Tailwick</h1>
                    </div>
                </div>
                ...
                <div className="container 2xl:max-w-[87.5rem] px-4 mx-auto">
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-12 gap-x-5">
                        <div className="xl:col-span-4">
                            <div className="transition-all duration-300 ease-linear -mt-36 card hover:-translate-y-2 dark:bg-zinc-600">
                                <div className="p-6">
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <p className="mb-3 text-slate-500 dark:text-zinc-200 text-16">A chat UI, or user interface, is one of the first things users see when using a web or mobile application to communicate.</p>
                                        <a href="#!" className="text-fecustom-500 text-16">Read More <MoveRight className="inline-block size-4 align-middle ltr:ml-1 rtl:mr-1 rtl:rotate-180" /></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="xl:col-span-4">
                            <div className="transition-all duration-300 ease-linear md:-mt-36 card hover:-translate-y-2 dark:bg-zinc-600">
                                <div className="p-6">
                        ...
                        <div className="xl:col-span-4">
                            <div className="transition-all duration-300 ease-linear xl:-mt-36 card hover:-translate-y-2 dark:bg-zinc-600">
                                <div className="p-6">
                    ...
                    <div className="p-10 mt-20 rounded-md bg-slate-900 dark:bg-zinc-700">
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-5">
                            <div className="text-center">
                                ...
                                <p className="text-16 text-slate-400 dark:text-zinc-200">Multiple Layouts</p>
                            </div>
                            <div className="text-center">
                                <h3 className="mb-2 text-slate-50 dark:text-zinc-50">
                                    <CountUp end={12} className="counter-value" /> +</h3>
                                <p className="text-16 text-slate-400 dark:text-zinc-200">Multi Languages</p>
                            </div>
                            <div className="text-center">
                                <h3 className="mb-2 text-slate-50 dark:text-zinc-50">
                                    <CountUp end={7} className="counter-value" /> +</h3>
                                <p className="text-16 text-slate-400 dark:text-zinc-200">Apps & Dashboard</p>
                            </div>
                            <div className="text-center">
                                <h3 className="mb-2 text-slate-50 dark:text-zinc-50">
                                    <CountUp end={4} className="counter-value" /> +</h3>
                                <p className="text-16 text-slate-400 dark:text-zinc-200">Multiple Modes</p>
                            </div>
                            <div className="text-center">
                                <h3 className="mb-2 text-slate-50 dark:text-zinc-50">
                                    <CountUp end={36500} className="counter-value" /> +</h3>
                                <p className="text-16 text-slate-400 dark:text-zinc-200">Happy Customers</p>
                            </div>
                        </div>
                    </div>
                </div>
