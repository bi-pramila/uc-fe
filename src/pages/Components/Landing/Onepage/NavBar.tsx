...
const NavBar = () => {
    ...
    return (
        <React.Fragment>
            <nav className={`fixed inset-x-0 top-0 z-50 flex items-center justify-center h-20 py-3 [&.is-sticky]:bg-white dark:[&.is-sticky]:bg-zinc-700 border-b border-slate-200 dark:border-zinc-500 [&.is-sticky]:shadow-lg [&.is-sticky]:shadow-slate-200/25 dark:[&.is-sticky]:shadow-zinc-500/30 navbar ${navClass}`} id="navbar">
                <div className="container 2xl:max-w-[87.5rem] px-4 mx-auto flex items-center self-center w-full">
                    ...
                    <div className="mx-auto">
                        <ul id="navbar7" className={`absolute inset-x-0 z-20 items-center py-3 bg-white shadow-lg dark:bg-zinc-600 dark:md:bg-transparent md:z-0 navbar-menu rounded-b-md md:shadow-none md:flex top-full ltr:ml-auto rtl:mr-auto md:relative md:bg-transparent md:rounded-none md:top-auto md:py-0 ${!isToggle ? "hidden" : ""}`}>
                            <li>
                                <a href="#home"
                            ...
                            <li>
                                <a href="#features"
                                    className={`block md:inline-block px-4 md:px-3 py-2.5 md:py-0.5 text-15 font-medium text-slate-800 transition-all duration-300 ease-linear hover:text-fecustom-500 [&.active]:text-fecustom-500 dark:text-zinc-100 dark:hover:text-fecustom-500 dark:[&.active]:text-fecustom-500 ${activeLink === "/Features" ? "active" : ""}`}
                            ...
                            <li>
                                <a href="#pricing"
                                    className={`block md:inline-block px-4 md:px-3 py-2.5 md:py-0.5 text-15 font-medium text-slate-800 transition-all duration-300 ease-linear hover:text-fecustom-500 [&.active]:text-fecustom-500 dark:text-zinc-100 dark:hover:text-fecustom-500 dark:[&.active]:text-fecustom-500 ${activeLink === "/Pricing" ? "active" : ""}`}
                    ...
                    <div className="flex gap-2">
                        ...
                        <button type="button" className="text-white btn bg-fecustom-500 border-fecustom-500 hover:text-white hover:bg-fecustom-600 hover:border-fecustom-600 focus:text-white focus:bg-fecustom-600 focus:border-fecustom-600 focus:ring focus:ring-fecustom-100 active:text-white active:bg-fecustom-600 active:border-fecustom-600 active:ring active:ring-fecustom-100 dark:ring-fecustom-400/20"><span className="align-middle">Sign In</span> <LogIn className="inline-block size-4 ltr:ml-1 rtl:mr-1"></LogIn></button>
                    </div>
                </div>
            </nav>
        </React.Fragment>
