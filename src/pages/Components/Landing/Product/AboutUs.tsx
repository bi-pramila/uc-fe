    ...
    return (
        <React.Fragment>
            <section className="relative py-24 xl:py-32" id="about">
                <div className="absolute bottom-0 right-0 size-64 bg-fecustom-500/10 blur-3xl"></div>
                <div className="container 2xl:max-w-[87.5rem] px-4 mx-auto">
                    <div className="grid items-center grid-cols-1 gap-6 mt-20 lg:grid-cols-12">
                        ...
                        <div className="ml-auto lg:col-span-5 lg:col-start-8">
                            ...
                            <button type="button" className="px-8 py-3 text-white border-0 text-15 btn bg-gradient-to-r from-fecustom-500 to-purple-500 hover:text-white hover:from-purple-500 hover:to-fecustom-500" data-aos="fade-left" data-aos-delay="600">
