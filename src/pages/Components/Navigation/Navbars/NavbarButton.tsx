    ...
    return (
        <React.Fragment>
            ...
            <nav className="group-data-[skin=bordered]:shadow-sm group-data-[skin=bordered]:border group-data-[skin=bordered]:border-slate-200 group-data-[skin=bordered]:dark:border-zinc-500 flex items-center h-16 px-4 py-2 bg-white rounded-md shadow-md  dark:bg-zinc-700 navbar">
                ...
                <ul id="navbar5" className="absolute inset-x-0 z-20 items-center hidden py-3 mx-auto bg-white shadow-lg dark:bg-zinc-600 dark:md:bg-transparent md:z-0 navbar-menu rounded-b-md md:shadow-none md:flex top-full md:relative md:bg-transparent md:rounded-none md:top-auto md:py-0">
                    <li>
                        <a href="#!"
                         className={`block md:inline-block px-4 md:px-3 py-2.5 md:py-0.5 text-15 font-medium text-slate-800 transition-all duration-300 ease-linear hover:text-fecustom-500 [&.active]:text-fecustom-500 dark:text-zinc-100 dark:hover:text-fecustom-500 dark:[&.active]:text-fecustom-500 acti ${activeLink === "/Home" ? "active": ""}`}
                    ...
                    <li>
                        <a href="#!"
                         className={`block md:inline-block px-4 md:px-3 py-2.5 md:py-0.5 text-15 font-medium text-slate-800 transition-all duration-300 ease-linear hover:text-fecustom-500 [&.active]:text-fecustom-500 dark:text-zinc-100 dark:hover:text-fecustom-500 dark:[&.active]:text-fecustom-500 ${activeLink === "/Service" ? "active": ""}`}
                ...
                <ul className="flex items-center ltr:ml-auto rtl:mr-auto">
                    <li>
                        <a href="#!" className="inline-flex items-center justify-center size-10 transition-all duration-300 ease-linear tems-center text-slate-500 hover:text-fecustom-500 active:text-fecustom-500 dark:text-zinc-200 dark:hover:text-fecustom-500 dark:active:text-fecustom-500 group/item">
