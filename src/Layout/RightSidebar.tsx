...
const RightSidebar = ({ handleToggleDrawer, isOpen }: any) => {
    ...
    return (
        <React.Fragment>
            <Drawer show={isOpen} onHide={handleToggleDrawer} id="customizerButton" drawer-end="true" className="fixed inset-y-0 flex flex-col w-full transition-transform duration-300 ease-in-out transform bg-white shadow ltr:right-0 rtl:left-0 md:w-96 z-drawer dark:bg-zinc-600">
                <div className="flex justify-between p-4 border-b border-slate-200 dark:border-zinc-500">
                    <div className="grow">
                        <h5 className="mb-1 text-16">Tailwick Theme Customizer</h5>
                        <p className="font-normal text-slate-500 dark:text-zinc-200">Choose your themes & layouts etc.</p>
                    </div>
                    <div className="shrink-0">
                        <Drawer.Header data-drawer-close="customizerButton" className="transition-all duration-150 ease-linear text-slate-500 hover:text-slate-800 dark:text-zinc-200 dark:hover:text-zinc-50">
                        ...
                        <div className="grid grid-cols-1 mb-5 gap-7 sm:grid-cols-2">
                            <div className="relative">
                                <input
                                    id="layout-one"
                                    name="dataLayout"
                                    className="absolute size-4 border rounded-full appearance-none cursor-pointer ltr:right-2 rtl:left-2 top-2 vertical-menu-btn bg-slate-100 border-slate-300 checked:bg-fecustom-500 checked:border-fecustom-500 dark:bg-zinc-400 dark:border-zinc-500"
                                    type="radio"
                                ...
                                />
                                <label className="block w-full h-24 p-0 overflow-hidden border rounded-lg cursor-pointer border-slate-200 dark:border-zinc-500" htmlFor="layout-one">
                                    <span className="flex h-full gap-0">
                                        <span className="shrink-0">
                                            <span className="flex flex-col h-full gap-1 p-1 ltr:border-r rtl:border-l border-slate-200 dark:border-zinc-500">
                                                <span className="block p-1 px-2 mb-2 rounded bg-slate-100 dark:bg-zinc-400"></span>
                                                <span className="block p-1 px-2 pb-0 bg-slate-100 dark:bg-zinc-500"></span>
                                                <span className="block p-1 px-2 pb-0 bg-slate-100 dark:bg-zinc-500"></span>
                                                <span className="block p-1 px-2 pb-0 bg-slate-100 dark:bg-zinc-500"></span>
                                            </span>
                                        </span>
                                        <span className="grow">
                                            <span className="flex flex-col h-full">
                                                <span className="block h-3 bg-slate-100 dark:bg-zinc-500"></span>
                                                <span className="block h-3 mt-auto bg-slate-100 dark:bg-zinc-500"></span>
                                            </span>
                                        </span>
                                    </span>
                                </label>
                            ...
                            <div className="relative">
                                ...
                                />
                                <label className="block w-full h-24 p-0 overflow-hidden border rounded-lg cursor-pointer border-slate-200 dark:border-zinc-500" htmlFor="layout-two">
                                    <span className="flex flex-col h-full gap-1">
                                        <span className="flex items-center gap-1 p-1 bg-slate-100 dark:bg-zinc-500">
                                            <span className="block p-1 ml-1 bg-white rounded dark:bg-zinc-500"></span>
                                            <span className="block p-1 px-2 pb-0 bg-white dark:bg-zinc-500 ms-auto"></span>
                                            <span className="block p-1 px-2 pb-0 bg-white dark:bg-zinc-500"></span>
                                        </span>
                                        <span className="block p-1 bg-slate-100 dark:bg-zinc-500"></span>
                                        <span className="block p-1 mt-auto bg-slate-100 dark:bg-zinc-500"></span>
                                    </span>
                                </label>
                            ...
                            <div className="flex items-center">
                                <div className="relative inline-block w-10 mr-2 align-middle transition duration-200 ease-in">
                                    <input
                                        ...
                                        className="absolute block size-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 bg-white/80 peer/published checked:bg-white checked:right-0 checked:border-fecustom-500 arrow-none dark:border-zinc-500 dark:bg-zinc-500 dark:checked:bg-zinc-400 checked:bg-none"
                                        checked={isClicked}
                                        onChange={() => handleSemiDarkMode()}
                                    />
                                    <label htmlFor="customDefaultSwitch" className="block h-5 overflow-hidden transition duration-300 ease-linear border rounded-full cursor-pointer border-slate-200 bg-slate-200 peer-checked/published:bg-fecustom-500 peer-checked/published:border-fecustom-500 dark:border-zinc-500 dark:bg-zinc-600"></label>
                                </div>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="grid grid-cols-1 mb-5 gap-7 sm:grid-cols-2">
                            <div className="relative">
                                ...
                                />
                                <label className="block w-full h-24 p-0 overflow-hidden border rounded-lg cursor-pointer border-slate-200 dark:border-zinc-500 bg-slate-50 dark:bg-zinc-600" htmlFor="layoutSkitOne">
                                    <span className="flex h-full gap-0">
                                        <span className="shrink-0">
                                            <span className="flex flex-col h-full gap-1 p-1 ltr:border-r rtl:border-l border-slate-200 dark:border-zinc-500">
                                                <span className="block p-1 px-2 mb-2 rounded bg-slate-100 dark:bg-zinc-400"></span>
                            ...
                            <div className="relative">
                                ...
                                />
                                <label className="block w-full h-24 p-0 overflow-hidden border rounded-lg cursor-pointer border-slate-200 dark:border-zinc-500" htmlFor="layoutSkitTwo">
                                    <span className="flex h-full gap-0">
                                        <span className="shrink-0">
                                            <span className="flex flex-col h-full gap-1 p-1 ltr:border-r rtl:border-l border-slate-200 dark:border-zinc-500">
                                                <span className="block p-1 px-2 mb-2 rounded bg-slate-100 dark:bg-zinc-400"></span>
                                        ...
                                        <span className="grow">
                                            <span className="flex flex-col h-full">
                                                <span className="block h-3 border-b border-slate-200 dark:border-zinc-500"></span>
                                                <span className="block h-3 mt-auto border-t border-slate-200 dark:border-zinc-500"></span>
                                            </span>
                                        </span>
                                    </span>
                                </label>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                [&.active]:text-fecustom-500 [&.active]:bg-fecustom-50 [&.active]:border-fecustom-200
                                dark:bg-zinc-600 dark:text-zinc-200 dark:border-zinc-400
                                dark:hover:bg-zinc-600 dark:hover:text-zinc-100 dark:hover:border-zinc-400
                                dark:[&.active]:bg-fecustom-500/10 dark:[&.active]:border-fecustom-500/30 dark:[&.active]:text-fecustom-500
                            ...
                            <button
                                ...
                                type="button" id="dataModeTwo" name="dataMode" className={`transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-fecustom-500 [&.active]:bg-fecustom-50 [&.active]:border-fecustom-200 dark:bg-zinc-600 dark:text-zinc-200 dark:border-zinc-400 dark:hover:bg-zinc-600 dark:hover:text-zinc-100 dark:hover:border-zinc-400 dark:[&.active]:bg-fecustom-500/10 dark:[&.active]:border-fecustom-500/30 dark:[&.active]:text-fecustom-500 ${layoutModeType === LAYOUT_MODE_TYPES.DARKMODE ? "active" : ""}`}>Dark Mode</button>
                        </div>
                    </div>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <button
                                ...
                                className={`transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-fecustom-500 [&.active]:bg-fecustom-50 [&.active]:border-fecustom-200 dark:bg-zinc-600 dark:text-zinc-200 dark:border-zinc-400 dark:hover:bg-zinc-600 dark:hover:text-zinc-100 dark:hover:border-zinc-400 dark:[&.active]:bg-fecustom-500/10 dark:[&.active]:border-fecustom-500/30 dark:[&.active]:text-fecustom-500  ${layoutDirectionType === LAYOUT_DIRECTION.LTR ? "active" : ""}`}>LTR Mode</button>
                            <button
                                value={LAYOUT_DIRECTION.RTL}
                                onClick={() => {
                                    dispatch(changeDirection(LAYOUT_DIRECTION.RTL));
                                }}
                                type="button" id="diractionTwo" name="dir" className={`transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-fecustom-500 [&.active]:bg-fecustom-50 [&.active]:border-fecustom-200 dark:bg-zinc-600 dark:text-zinc-200 dark:border-zinc-400 dark:hover:bg-zinc-600 dark:hover:text-zinc-100 dark:hover:border-zinc-400 dark:[&.active]:bg-fecustom-500/10 dark:[&.active]:border-fecustom-500/30 dark:[&.active]:text-fecustom-500 ${layoutDirectionType === LAYOUT_DIRECTION.RTL ? "active" : ""}`}>RTL Mode</button>
                        </div>
                    </div>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                type="button" id="datawidthOne" name="datawidth" className={`transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-fecustom-500 [&.active]:bg-fecustom-50 [&.active]:border-fecustom-200 dark:bg-zinc-600 dark:text-zinc-200 dark:border-zinc-400 dark:hover:bg-zinc-600 dark:hover:text-zinc-100 dark:hover:border-zinc-400 dark:[&.active]:bg-fecustom-500/10 dark:[&.active]:border-fecustom-500/30 dark:[&.active]:text-fecustom-500 ${layoutContentWidthType === LAYOUT_CONTENT_WIDTH.FLUID ? "active" : ""}`}>Fluid</button>
                            <button
                    ...
                    {layoutType === "vertical" && <div className="mt-6" id="sidebar-size">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <button
                                ...
                                type="button" id="sidebarSizeOne" name="sidebarSize" className={`transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-fecustom-500 [&.active]:bg-fecustom-50 [&.active]:border-fecustom-200 dark:bg-zinc-600 dark:text-zinc-200 dark:border-zinc-400 dark:hover:bg-zinc-600 dark:hover:text-zinc-100 dark:hover:border-zinc-400 dark:[&.active]:bg-fecustom-500/10 dark:[&.active]:border-fecustom-500/30 dark:[&.active]:text-fecustom-500 ${layoutSidebarSizeType === LEFT_SIDEBAR_SIZE_TYPES.DEFAULT ? "active" : ""}`}>Default</button>
                            <button
                                value={LEFT_SIDEBAR_SIZE_TYPES.COMPACT}
                                onClick={() => {
                                    dispatch(changeLeftsidebarSizeType(LEFT_SIDEBAR_SIZE_TYPES.COMPACT));
                                }}
                                type="button" id="sidebarSizeTwo" name="sidebarSize" className={`transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-fecustom-500 [&.active]:bg-fecustom-50 [&.active]:border-fecustom-200 dark:bg-zinc-600 dark:text-zinc-200 dark:border-zinc-400 dark:hover:bg-zinc-600 dark:hover:text-zinc-100 dark:hover:border-zinc-400 dark:[&.active]:bg-fecustom-500/10 dark:[&.active]:border-fecustom-500/30 dark:[&.active]:text-fecustom-500 ${layoutSidebarSizeType === LEFT_SIDEBAR_SIZE_TYPES.COMPACT ? "active" : ""}`}>Compact</button>
                            <button
                                value={LEFT_SIDEBAR_SIZE_TYPES.SMALLICON}
                                onClick={() => {
                                    dispatch(changeLeftsidebarSizeType(LEFT_SIDEBAR_SIZE_TYPES.SMALLICON));
                                }}
                                type="button" id="sidebarSizeThree" name="sidebarSize" className={`transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-fecustom-500 [&.active]:bg-fecustom-50 [&.active]:border-fecustom-200 dark:bg-zinc-600 dark:text-zinc-200 dark:border-zinc-400 dark:hover:bg-zinc-600 dark:hover:text-zinc-100 dark:hover:border-zinc-400 dark:[&.active]:bg-fecustom-500/10 dark:[&.active]:border-fecustom-500/30 dark:[&.active]:text-fecustom-500 ${layoutSidebarSizeType === LEFT_SIDEBAR_SIZE_TYPES.SMALLICON ? "active" : ""}`}>Small (Icon)</button>
                        </div>
                    </div>}
                    ...
                    {layoutType === "vertical" && <div className="mt-6" id="sidebar-color">
                        ...
                        <div className="flex flex-wrap gap-3">
                            ...
                            <button
                                ...
                                type="button" id="sidebarColorTwo" name="sidebarColor" className={`flex items-center justify-center size-10 border rounded-md border-zinc-900 bg-zinc-900 group ${layoutSidebarColorType === LEFT_SIDEBAR_COLOR_TYPES.DARK ? "active" : ""}`}><Check className="size-5 hidden group-[.active]:inline-block text-white" /></button>
                            <button
                                value={LEFT_SIDEBAR_COLOR_TYPES.BRAND}
                                onClick={() => {
                                    dispatch(changeLeftSidebarColorType(LEFT_SIDEBAR_COLOR_TYPES.BRAND));
                                }}
                                type="button" id="sidebarColorThree" name="sidebarColor" className={`flex items-center justify-center size-10 border rounded-md border-fecustom-800 bg-fecustom-800 group ${layoutSidebarColorType === LEFT_SIDEBAR_COLOR_TYPES.BRAND ? "active" : ""}`}><Check className="size-5 hidden group-[.active]:inline-block text-white" /></button>
                            <button
                    ...
                    <div className="mt-6">
                        ...
                        <div className="flex flex-wrap gap-3">
                            ...
                            <button
                                ...
                                type="button" id="topbarColorTwo" name="topbarColor" className={`flex items-center justify-center size-10 border rounded-md border-zinc-900 bg-zinc-900 group ${layoutTopbarColorType === LAYOUT_TOPBAR_THEME_TYPES.DARK ? "active" : ""}`}><Check className="size-5 hidden group-[.active]:inline-block text-white" /></button>
                            <button
                                value={LAYOUT_TOPBAR_THEME_TYPES.BRAND}
                                onClick={() => {
                                    dispatch(changeLayoutTopbarColor(LAYOUT_TOPBAR_THEME_TYPES.BRAND));
                                }}
                                type="button" id="topbarColorThree" name="topbarColor" className={`flex items-center justify-center size-10 border rounded-md border-fecustom-800 bg-fecustom-800 group ${layoutTopbarColorType === LAYOUT_TOPBAR_THEME_TYPES.BRAND ? "active" : ""}`}><Check className="size-5 hidden group-[.active]:inline-block text-white" /></button>
                        </div>
                    </div>

                </Drawer.Body>
                <div className="flex items-center justify-between gap-3 p-4 border-t border-slate-200 dark:border-zinc-500">
